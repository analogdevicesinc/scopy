...
install_apt() {
	...
	# Ran these when trying to build on another host
	sudo apt-get -y install qtcreator qtdeclarative5-dev qtdeclarative5-dev-tools libqt5svg5 libqt5svg5-dev qttools5-dev qttools5-dev-tools libqt5opengl5
	sudo apt-get -y install libqwt-qt5-6

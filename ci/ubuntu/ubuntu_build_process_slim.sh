...
# Qt6 SLIM Build and Install Dependencies for Ubuntu (dependency-rework pass)
# ===========================
# Usage: ./ubuntu_build_process_slim.sh configure_system
#
# Derived from ubuntu_build_process.sh. Drops the gnuradio + sigrok + libm2k
# dependency stacks (and their transitive apt packages) and adds libad9166.
# The original script is kept unchanged as the known-good baseline (Stage 1).
# See docs/design/scopy_deps_cleanup/dependency-decisions.md for per-dep rationale.

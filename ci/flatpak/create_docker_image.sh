...
build_docker(){
	...
	docker build -t docker.cloudsmith.io/adi/scopy-dockers/scopy2-flatpak-qt6:testing  .
	...
	docker run \
		...
		docker.cloudsmith.io/adi/scopy-dockers/scopy2-flatpak-qt6:testing /bin/bash -c /home/runner/config/build_flatpak_deps.sh

	docker commit $CONTAINER_NAME docker.cloudsmith.io/adi/scopy-dockers/scopy2-flatpak-qt6:testing
	echo "Docker container $CONTAINER_NAME commited as docker.cloudsmith.io/adi/scopy-dockers/scopy2-flatpak-qt6:testing image"

...
set(STAGING_AREA 			$ENV{HOME}/scopy-build)
set(TOOLCHAIN_FILE                 	${STAGING_AREA}/cross-pi-gcc)
set(CMAKE_SYSROOT               	${STAGING_AREA}/sysroot)
...
set(PKG_CONFIG_EXECUTABLE          	"${CMAKE_SYSROOT}/usr/bin/arm-linux-gnueabihf-pkg-config" CACHE PATH "PKG_CONFIG_EXECUTABLE" FORCE)
...
set(ENV{PKG_CONFIG_PATH}           	"$ENV{PKG_CONFIG_PATH}:${CMAKE_SYSROOT}/include:${CMAKE_SYSROOT}/usr/include:${CMAKE_SYSROOT}/usr/include/arm-linux-gnueabihf:${CMAKE_SYSROOT}/usr/share/include")
set(ENV{PKG_CONFIG_SYSROOT_DIR}    	"${CMAKE_SYSROOT}")

set(ENV{LD_LIBRARY_PATH}           	"${CMAKE_SYSROOT}/usr/lib/arm-linux-gnueabihf:$ENV{LD_LIBRARY_PATH}")
set(CMAKE_LIBRARY_PATH             	"${CMAKE_SYSROOT}/usr/lib" "${CMAKE_SYSROOT}/usr/lib/arm-linux-gnueabihf" "${CMAKE_SYSROOT}/usr/local/lib" "${CMAKE_SYSROOT}/usr/local/lib/arm-linux-gnueabihf")
...
set(CMAKE_C_FLAGS                  	"${CMAKE_C_FLAGS} -I${CMAKE_SYSROOT}/include -I${CMAKE_SYSROOT}/usr/include -I${CMAKE_SYSROOT}/usr/include/arm-linux-gnueabihf -I${CMAKE_SYSROOT}/usr/share/include -fPIC")

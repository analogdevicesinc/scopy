...
class SwTriggerStrategy : public PlottingStrategy, public QObject
{
public:
	SwTriggerStrategy(int samplingFreq, QString triggeredBy, QObject *parent = nullptr);
	~SwTriggerStrategy();

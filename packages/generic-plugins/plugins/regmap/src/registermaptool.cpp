	...
	: QWidget{parent}
{
	...
	tool->layout()->setContentsMargins(4, 4, 4, 4);
...
void RegisterMapTool::startActiveDeviceTutorial() { deviceList->value(activeRegisterMap)->startTutorial(); }

void RegisterMapTool::startActiveDeviceSimpleTutorial() { deviceList->value(activeRegisterMap)->startSimpleTutorial(); }

...

{
	...
	connect(waterfallInvertSwitch->onOffswitch(), &QAbstractButton::toggled, this, [=](bool inverted) {
		m_plotComponent->waterfallPlot()->setInverted(inverted);
	});
	...
	m_plotComponent->waterfallPlot()->setNumRows(200);

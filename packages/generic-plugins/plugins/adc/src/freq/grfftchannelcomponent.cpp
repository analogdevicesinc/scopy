...
QWidget *GRFFTChannelComponent::createMinMaxHoldMenu(QWidget *parent)
{
	...
	QPushButton *minResetBtn = new QPushButton(section);
	minResetBtn->setIcon(
		Style::getPixmap(":/gui/icons/refresh.svg", Style::getColor(json::theme::content_inverse)));
	minResetBtn->setFixedSize(btnSize, btnSize);
	minResetBtn->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
	Style::setStyle(minResetBtn, style::properties::button::smallSquareIconButton);
	...
	QPushButton *maxResetBtn = new QPushButton(section);
	maxResetBtn->setIcon(
		Style::getPixmap(":/gui/icons/refresh.svg", Style::getColor(json::theme::content_inverse)));
	maxResetBtn->setFixedSize(btnSize, btnSize);
	maxResetBtn->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
	Style::setStyle(maxResetBtn, style::properties::button::smallSquareIconButton);

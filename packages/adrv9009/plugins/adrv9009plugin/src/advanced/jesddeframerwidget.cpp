...
void JesdDeframerWidget::setupUi()
{
	...
	qDebug(CAT_JESDDEFRAMER) << "JESD Deframer widget created with 42 attributes in A|B column layout";
}

QWidget *JesdDeframerWidget::createDeframerColumn(const QString &columnType, const QString &attrPrefix, QWidget *parent)
{
	// JESD Deframer column using MenuSectionCollapseWidget (21 attributes)

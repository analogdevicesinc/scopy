...
AgcSetupWidget::AgcSetupWidget(component::Device *device, IIOWidgetGroup *group, QWidget *parent)
	: QWidget(parent)
	, m_device(device)
	, m_widgetGroup(group)
{
...
void AgcSetupWidget::setupUi()
{
	...
	qDebug(CAT_AGCSETUP) << "AGC Setup widget created with 65 attributes in 3 collapsible sections";
}

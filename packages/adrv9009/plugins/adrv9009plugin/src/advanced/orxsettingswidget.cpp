...
OrxSettingsWidget::OrxSettingsWidget(component::Device *device, IIOWidgetGroup *group, QWidget *parent)
	: QWidget(parent)
	, m_device(device)
	, m_widgetGroup(group)
{
...
QWidget *OrxSettingsWidget::createOrxProfileSection(QWidget *parent)
{
	...
	orxProfileSection->contentLayout()->addWidget(widget);
...
QWidget *OrxSettingsWidget::createOrxConfigSection(QWidget *parent)
{
	...
	orxConfigSection->contentLayout()->addWidget(widget);
	Style::setBackgroundColor(widget, json::theme::background_primary);
	Style::setStyle(widget, style::properties::widget::border_interactive);
...
QWidget *OrxSettingsWidget::createAuxPllSection(QWidget *parent)
{
	...
	auxPllSection->contentLayout()->addWidget(widget);
	Style::setBackgroundColor(widget, json::theme::background_primary);
	Style::setStyle(widget, style::properties::widget::border_interactive);

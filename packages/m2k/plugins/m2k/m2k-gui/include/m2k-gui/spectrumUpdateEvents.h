...
class SCOPY_M2K_GUI_EXPORT SpectrumUpdateEvent : public QEvent
{
...
class SCOPY_M2K_GUI_EXPORT SpectrumWindowCaptionEvent : public QEvent
{
public:
...
class SCOPY_M2K_GUI_EXPORT SpectrumWindowResetEvent : public QEvent
{
public:
...
class SCOPY_M2K_GUI_EXPORT SpectrumFrequencyRangeEvent : public QEvent
{
public:
...
class SCOPY_M2K_GUI_EXPORT TimeUpdateEvent : public QEvent
{
public:
...
class SCOPY_M2K_GUI_EXPORT IdentifiableTimeUpdateEvent : public TimeUpdateEvent
{
public:
...
class SCOPY_M2K_GUI_EXPORT FreqUpdateEvent : public QEvent
{
public:
...
class SCOPY_M2K_GUI_EXPORT SetFreqEvent : public QEvent
{
public:
...
class SCOPY_M2K_GUI_EXPORT ConstUpdateEvent : public QEvent
{
public:
...
class SCOPY_M2K_GUI_EXPORT WaterfallUpdateEvent : public QEvent
{
public:
...
class SCOPY_M2K_GUI_EXPORT TimeRasterUpdateEvent : public QEvent
{
public:
...
class SCOPY_M2K_GUI_EXPORT HistogramUpdateEvent : public QEvent
{
public:
...
class SCOPY_M2K_GUI_EXPORT NumberUpdateEvent : public QEvent
{
public:

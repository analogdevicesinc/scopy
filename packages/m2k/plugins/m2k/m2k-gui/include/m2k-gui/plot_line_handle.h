...
class SCOPY_M2K_GUI_EXPORT PlotLineHandle : public QWidget
{
	Q_OBJECT
...
class SCOPY_M2K_GUI_EXPORT PlotGateHandle : public PlotLineHandle
{
public:
...
class SCOPY_M2K_GUI_EXPORT PlotLineHandleH : public PlotLineHandle
{
public:
...
class SCOPY_M2K_GUI_EXPORT PlotLineHandleV : public PlotLineHandle
{
public:
...
class SCOPY_M2K_GUI_EXPORT FreePlotLineHandleH : public PlotLineHandleH
{
public:
...
class SCOPY_M2K_GUI_EXPORT FreePlotLineHandleV : public PlotLineHandleV
{
public:
...
class SCOPY_M2K_GUI_EXPORT RoundedHandleV : public FreePlotLineHandleV
{
	Q_OBJECT
public:

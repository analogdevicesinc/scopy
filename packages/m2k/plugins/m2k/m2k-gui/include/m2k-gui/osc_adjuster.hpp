...
class SCOPY_M2K_GUI_EXPORT OscAdjuster : public QObject
{
	Q_OBJECT
public:
...
class SCOPY_M2K_GUI_EXPORT VertMouseGestures : public OscAdjuster
{
	Q_OBJECT
public:
...
class SCOPY_M2K_GUI_EXPORT HorizMouseGestures : public OscAdjuster
{
	Q_OBJECT
public:

...
BufferMenuView::BufferMenuView(QMap<QString, component::Channel *> chnls, IIOWidgetGroup *widgetGroup, QWidget *parent)
	: QWidget(parent)
...
{
	m_swiotAdvMenu = BufferMenuBuilder::newAdvMenu(this, function, m_chnls, m_widgetGroup);

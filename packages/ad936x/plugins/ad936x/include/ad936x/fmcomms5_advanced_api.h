...
#ifndef FMCOMMS5_ADVANCED_API_H
#define FMCOMMS5_ADVANCED_API_H
...
class SCOPY_AD936X_EXPORT FMCOMMS5_ADVANCED_API : public ApiObject
{
	Q_OBJECT
public:
	explicit FMCOMMS5_ADVANCED_API(Ad936xPlugin *plugin);
	~FMCOMMS5_ADVANCED_API();
	...
	// --- FMCOMMS5 Calibration (Fmcomms5Tab) ---
	Q_INVOKABLE QString getTxPhase();
	Q_INVOKABLE void setTxPhase(const QString &value);

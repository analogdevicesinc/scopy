...
{
	const QList<Plugin *> loadedPlugins = PluginRepository::getOriginalPlugins();
...
{
	const QList<PluginManager::PluginInfo> unloadedPlugins = PluginRepository::getUnloadedPlugins();

...
TestFramework.runTest("TST.OSC.TRIGGER_FUNCTION_1", function() {
    ...
    printToConsole("  INFO: Visual check - signal should be NOT triggered (level outside range)");
...
TestFramework.runTest("TST.OSC.GATING", function() {
    ...
    var vpp = osc.channels[0].peak_to_peak;
    pass = TestFramework.assertApproxEqual(vpp, 2.5, 0.5,
        "Step 4: Gated half-period Vpp ~2.5V") && pass;
    ...
    vpp = osc.channels[0].peak_to_peak;
    pass = TestFramework.assertApproxEqual(vpp, 5.0, 0.5,

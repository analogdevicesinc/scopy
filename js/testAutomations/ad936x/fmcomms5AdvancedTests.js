...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.isFddModeEnabled();
        ...
        if (original) { fmcomms5_advanced.setFddModeEnabled(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.isEnsmPinPulseModeEnabled();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setEnsmPinPulseModeEnabled(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.isEnsmTxnrxControlEnabled();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setEnsmTxnrxControlEnabled(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.isTddDualSynthModeEnabled();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setTddDualSynthModeEnabled(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.isTddFddVcoTablesEnabled();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setTddFddVcoTablesEnabled(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.isTddSkipVcoCalEnabled();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setTddSkipVcoCalEnabled(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.isUpdateTxGainInAlertEnabled();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setUpdateTxGainInAlertEnabled(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.isRx1Rx2PhaseInversionEnabled();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setRx1Rx2PhaseInversionEnabled(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.isXoDisableUseExtRefclkEnabled();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setXoDisableUseExtRefclkEnabled(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.isExternalRxLoEnabled();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setExternalRxLoEnabled(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.isExternalTxLoEnabled();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setExternalTxLoEnabled(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.isRxFastlockPincontrolEnabled();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setRxFastlockPincontrolEnabled(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getRxFastlockDelay();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setRxFastlockDelay(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.isTxFastlockPincontrolEnabled();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setTxFastlockPincontrolEnabled(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getTxFastlockDelay();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setTxFastlockDelay(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getElnaGain();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setElnaGain(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getElnaBypassLoss();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setElnaBypassLoss(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getElnaSettlingDelay();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setElnaSettlingDelay(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.isElnaRx1Gpo0ControlEnabled();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setElnaRx1Gpo0ControlEnabled(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.isElnaRx2Gpo1ControlEnabled();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setElnaRx2Gpo1ControlEnabled(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.isElnaGaintableAllIndexEnabled();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setElnaGaintableAllIndexEnabled(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getRssiDuration();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setRssiDuration(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getRssiDelay();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setRssiDelay(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getRssiWait();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setRssiWait(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.isSplitGainTableModeEnabled();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setSplitGainTableModeEnabled(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getGcDecPowMeasurementDuration();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setGcDecPowMeasurementDuration(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getAgcAttackDelayExtraMargin();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setAgcAttackDelayExtraMargin(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getAgcOuterThreshHigh();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setAgcOuterThreshHigh(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getAgcInnerThreshHigh();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setAgcInnerThreshHigh(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getAgcInnerThreshLow();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setAgcInnerThreshLow(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getAgcOuterThreshLow();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setAgcOuterThreshLow(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getAgcGainUpdateInterval();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setAgcGainUpdateInterval(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getTxmonLowHighThresh();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setTxmonLowHighThresh(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getTxmonLowGain();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setTxmonLowGain(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getTxmonHighGain();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setTxmonHighGain(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.isTxmonDcTrackingEnabled();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setTxmonDcTrackingEnabled(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.isTxmonOneShotModeEnabled();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setTxmonOneShotModeEnabled(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getTempSenseMeasurementInterval();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setTempSenseMeasurementInterval(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.isTempSensePeriodicMeasurementEnabled();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setTempSensePeriodicMeasurementEnabled(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getDcOffsetAttenuationHighRange();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setDcOffsetAttenuationHighRange(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getDcOffsetAttenuationLowRange();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setDcOffsetAttenuationLowRange(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.isQecTrackingSlowModeEnabled();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setQecTrackingSlowModeEnabled(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    var original;
    try {
        original = fmcomms5_advanced.getTxPhase();
        ...
        printToConsole("  Error: " + e);
        if (original) { fmcomms5_advanced.setTxPhase(original); msleep(500); }
        return false;
    }
});
...
TestFramework.runTest("TST.FMCOMMS5_ADVANCED.PLUGIN_DETECTION_AND_DISPLAY", function() {
    ...
    try {
        ...
        key = keys[0];
        original = fmcomms5_advanced.readWidget(key);
        ...
        printToConsole("  Error: " + e);
        if (key && original) { fmcomms5_advanced.writeWidget(key, original); msleep(500); }
        return false;
    }
});

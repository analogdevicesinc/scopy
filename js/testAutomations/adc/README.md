...
Same steps as DocTests but with `VISUAL CHECK:` log markers and 3-second pauses for human observation. Excludes three non-visual tests: TST.MEASURE (value-based pass/fail, not visually verifiable), TST.ADC_TIME.PRINT, and TST.ADC_FREQ.PRINT_PLOT.

	...
	, animationDuration(200)
{
	...
	connect(&open_anim_max, &QAbstractAnimation::finished, this, &MenuAnim::openAnimFinished);
	connect(&close_anim_max, &QAbstractAnimation::finished, this, &MenuAnim::closeAnimFinished);
}

	...
	: QWidget(parent)
{
	...
	m_ui->leftContainer->setStyleSheet(".QWidget { background-color: transparent; }");
	m_ui->topContainerMenuControl->setStyleSheet(".QWidget { background-color: " + Style::getAttribute(json::theme::background_primary) + "; }");
}

	...
	, m_baseDirectory("")
{
	...
	Style::setStyle(m_lineEdit, style::properties::lineedit::fileBrowserEdit);
...
void FileBrowserWidget::browseFile()
{
	...
	QString filePath;
	switch(m_type) {
	case FileBrowserWidget::BrowserDialogType::FILE:
		filePath = QFileDialog::getOpenFileName(
			this, tr("Choose a file"), m_baseDirectory, m_filter, nullptr,

...
void Scale::setUnit(const QString &newUnit) { m_unit = newUnit; }

void Scale::computeScale(double val)
{
...
void Scale::setHasPrefix(bool newHasPrefix) { m_hasPrefix = newHasPrefix; }

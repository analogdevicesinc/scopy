...
All widgets in the Waveform instrument are dockable, allowing users to
...
#. From the menu on the left, you can select the desired instrument. To the right
   of the name, there is a button that allows you to start or stop data acquisition.
...
.. topic:: Settings menu
   ...
   #. Log: Enable or disable logging for the Waveform instrument. When

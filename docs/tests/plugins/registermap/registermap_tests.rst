...
Description:
    Verify that the user can read the register value.

OS: any

Precodition:
    * :ref:`M2k.Emu <m2k_emu_setup>` is connected
...
Description:
    Verify that the user can write the register value.

OS: any

Precodition:    
    * Test 1 is passed
    * :ref:`AdalmPluto.Device <adalm_pluto_device_setup>` is connected
...
Description:
    Verify that the user can not write the wrong value to the register.
...
Description:
    Verify that the user can change the device.

OS: any

Precodition:
    * :ref:`AdalmPluto.Device <adalm_pluto_device_setup>` or 
      :ref:`AdalmPluto.Emu <adalm_pluto_emu_setup>` is connected
...
Description:
    Verify that the user can see the register map table.
...
Description:
    Verify that the user can search the for a register.
...
Description:
    Verify that the user can see the register value in the table updated 
    on read.
...
Description:
    Verify that the detailed register bitfields value is updated on read.
...
Description:
    Verify that the detailed register bitfields value is updated on write.
...
Description:
    Verify that when value of the bitfield is changed the "Value field" is 
...
Description:
    Verify that when value of the "Value" field is changed the detailed 
...
Description:
    Verify that when the register is changed the detailed register bitfields 
    are updated.
...
Description:
    Verify that the user can toggle the detailed register visibility.
...
Description:
    Verify that the autoread setting is working.
...
Description:
    Verify that the read interval setting is working.
...
Description:
    Verify that the read interval setting is not working with wrong 
    interval.
...
Description:
    Verify that the register dump is working.
...
Description:
    Verify that the write values setting is working.
...
Description:
    Verify that the "Register dump" and "Write values" buttons are disabled 
...
Steps:
    ...
    5. Use find path button to select a file
                ...
                * Expected result: The write values amd register dump 
                  buttons are enabled
...
Description:
    Verify that the background color of the register in the table is 
...
Description:
    Verify that the text color of the register in the table is changing to 
...
Description:
    Verify that the colors used for the values are corect.
...
Description:
    Verify that the color coding is changing dynamically.
...
Description:
    Verify that the preferences are saved on close.
...
Description:
    Verify that the user can see the documentation for the register.
...
Description:
    Verify that the user can see the tutorial for the register.
...
Description:
    Verify that the user can see the tutorial for the register when no XML 
    file is present.

OS: any

Precodition: 
    * :ref:`M2k<m2k_emu_setup>` is connected
...
Steps:
    ...
    3. Press "Tutorial" button
                ...
                * Expected result: A tutorial explaining how to use the 
                  plugin is displayed and dose not include explanation of 
...
Description:
    Verify that the user can use a custom XML file.

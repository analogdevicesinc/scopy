...
**Steps:**
    ...
    2. Press **+** button
             ...
             - **Expected result:** New tool is created
...
**Prerequisites:**
    - :ref:`Create a New Data Logger Tool <TST_DATALOGGER_CREATAE_NEW_DATA_LOGGER_TOOL>` is passed
...
**Steps:**
    ...
    6. Chose directory where to save the file
             ...
             - **Expected result:** Data is saved to a pdf file in the chosen directory

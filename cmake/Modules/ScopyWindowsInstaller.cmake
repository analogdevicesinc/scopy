...
function(ConfigureInstallerSettings PACKAGE_TARGET_NAME PACKAGE_INSTALLER_DESCRIPTION FIXED_INSTALLER_OPTION)
	...
	set(COMPONENT_ENTRY
	    "Name: \"packages/${PACKAGE_TARGET_NAME_REPLACED}\"; Description: ${PACKAGE_INSTALLER_DESCRIPTION}; Types: full packages ${SELECTABLE};"
	)
	if("${PACKAGE_COMPONENTS}" STREQUAL "")
		set(PACKAGE_COMPONENTS "${COMPONENT_ENTRY}" CACHE STRING "PACKAGE COMPONENTS FOR WINDOWS INSTALLER"
								  FORCE
		)
	else()
		set(PACKAGE_COMPONENTS "${PACKAGE_COMPONENTS}\n${COMPONENT_ENTRY}"
		    CACHE STRING "PACKAGE COMPONENTS FOR WINDOWS INSTALLER" FORCE
		)
	endif()

	set(FILES_ENTRY
	    "Source:\"{#DestFolder}\\packages\\${PACKAGE_TARGET_NAME}\\\*\"; DestDir: \"{app}\\packages\\${PACKAGE_TARGET_NAME}\"; Components: packages\\${PACKAGE_TARGET_NAME_REPLACED}; Flags: ignoreversion onlyifdoesntexist recursesubdirs createallsubdirs;"
	)
	if("${PACKAGE_COMPONENTS_FILES}" STREQUAL "")
		set(PACKAGE_COMPONENTS_FILES "${FILES_ENTRY}"
		    CACHE STRING "PACKAGE COMPONENTS FILES FOR WINDOWS INSTALLER" FORCE
		)
	else()

...
function(generate_translations OUTPUT_LOC)
	file(GLOB TS_FILES ${CMAKE_CURRENT_SOURCE_DIR}/resources/translations/*.ts)
	set_source_files_properties(
		${TS_FILES} PROPERTIES OUTPUT_LOCATION ${OUTPUT_LOC} MACOSX_PACKAGE_LOCATION ${OUTPUT_LOC}
	)
	...
	foreach(file ${TS_FILES})
		...
		set(TRANSLATIONS "${TRANSLATIONS}\n<file>${OUTPUT_LOC}/${file_name}.qm</file>")
	endforeach()
	...
	if(DEFINED PACKAGE_NAME)
		add_custom_target(translations_${PACKAGE_NAME} ALL DEPENDS ${QM_FILES})
	endif()
endfunction()

...
public Q_SLOTS:
	...
	void onEmitStatus(QDateTime timestamp, QString oldData, QString newData, int retCode, bool readOp);
...
public Q_SLOTS:
	void onDiagSamplingChange() override;
	void onSamplingFreqWrite(QDateTime timestamp, QString oldData, QString newData, int retCode, bool readOp);
};

...
// GRTimeSinkComponent::GRTimeSinkComponent(QString name, TopBlockNode *t, QObject *parent)
// 	: QObject(parent)
// {
// 	m_node = t;
// 	m_sync = m_node->sync();
...
// {
// 	connect(this, &GRTimeSinkComponent::requestRebuild, m_top, &TopBlock::rebuild, Qt::QueuedConnection);
...
// 	m_armed = false;
// 	Q_EMIT disarm();
// 	disconnect(this, &GRTimeSinkComponent::requestRebuild, m_top, &TopBlock::rebuild);

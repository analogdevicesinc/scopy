	...
	: QWidget(parent)
{
	...
	m_timePlot->leftHandlesArea()->setVisible(true);
	m_timePlot->rightHandlesArea()->setVisible(true);
	m_timePlot->bottomHandlesArea()->setVisible(true);
	...
	m_xyPlot->leftHandlesArea()->setVisible(true);
	m_xyPlot->rightHandlesArea()->setVisible(true);
	m_xyPlot->bottomHandlesArea()->setVisible(true);
...
void PlotChannelComponent::initPlotComponent(PlotComponent *plotComponent) {
	...
	m_timePlotCh = new PlotChannel(m_ch->name(), m_ch->pen(), timeplot, timeplot->xAxis(), m_timePlotYAxis, this);
	m_timePlotAxisHandle = new PlotAxisHandle(m_ch->pen(), m_timePlotYAxis, timeplot, yPlotAxisHandle, this);
	...
	m_xyPlotCh = new PlotChannel(m_ch->name(), m_ch->pen(), xyplot, xyplot->xAxis(), m_xyPlotYAxis, this);

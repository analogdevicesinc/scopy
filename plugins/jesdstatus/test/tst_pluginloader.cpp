...
class TST_JesdStatusPlugin : public QObject
{
	Q_OBJECT
private Q_SLOTS:
	void fileExists();
...
void TST_JesdStatusPlugin::isLibrary() { QVERIFY(QLibrary::isLibrary(FILENAME)); }

void TST_JesdStatusPlugin::className()
{
	QPluginLoader qp(FILENAME, this);
	QVERIFY(qp.metaData().value("className") == "JesdStatusPlugin");
}

void TST_JesdStatusPlugin::loaded()
{
	QPluginLoader qp(FILENAME, this);
	qp.load();
	QVERIFY(qp.isLoaded());
...
void TST_JesdStatusPlugin::instanceNotNull()
{
	QPluginLoader qp(FILENAME, this);
	QVERIFY(qp.instance() != nullptr);
}

void TST_JesdStatusPlugin::multipleInstances()
{
...
void TST_JesdStatusPlugin::qobjectcast_to_plugin()
{
	QPluginLoader qp(FILENAME, this);
...
void TST_JesdStatusPlugin::clone()
{
	QPluginLoader qp(FILENAME, this);
...
void TST_JesdStatusPlugin::name()
{
	QPluginLoader qp(FILENAME, this);
...
void TST_JesdStatusPlugin::metadata()
{
	QPluginLoader qp(FILENAME, this);
...
QTEST_MAIN(TST_JesdStatusPlugin)

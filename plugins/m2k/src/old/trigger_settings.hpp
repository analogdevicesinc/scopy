...
public:
	...
	explicit TriggerSettings(libm2k::analog::M2kAnalogIn *libm2k_adc, QWidget *parent = nullptr);
	~TriggerSettings();
...
public Q_SLOTS:
	...
	void setTriggerLevelRange(int chn, const std::pair<double, double> &range);
	void setTriggerHystRange(int chn, const std::pair<double, double> &range);
...
private:
	...
	libm2k::M2K_TRIGGER_MODE determineTriggerMode(bool intern_checked, bool extern_checked) const;

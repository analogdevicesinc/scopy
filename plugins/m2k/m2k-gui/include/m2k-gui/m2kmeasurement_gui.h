...
class SCOPY_M2K_GUI_EXPORT M2kMeasurementGui
{
public:
	M2kMeasurementGui();
...
class SCOPY_M2K_GUI_EXPORT M2kMetricMeasurementGui : public M2kMeasurementGui
{
public:
...
class SCOPY_M2K_GUI_EXPORT M2kTimeMeasurementGui : public M2kMeasurementGui
{
public:
...
class SCOPY_M2K_GUI_EXPORT M2kPercentageMeasurementGui : public M2kMeasurementGui
{
public:
...
class SCOPY_M2K_GUI_EXPORT M2kDecibelsMeasurementGui : public M2kMeasurementGui
{
public:
...
class SCOPY_M2K_GUI_EXPORT M2kDecibelstoCarrierMeasurementGui : public M2kMeasurementGui
{
public:
...
class SCOPY_M2K_GUI_EXPORT M2kDimensionlessMeasurementGui : public M2kMeasurementGui
{
public:

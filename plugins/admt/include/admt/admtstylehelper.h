...
public:
	...
	static void TextStyle(QWidget *widget, const char *styleHelperColor = json::global::white, bool isBold = false,
	...
	static void CalculatedCoeffWidgetRowStyle(QWidget *widget, QHBoxLayout *layout, QLabel *hLabel,

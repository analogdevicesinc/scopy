...
static double motorMicrostepPerRevolution =
    motorFullStepPerRevolution * microStepResolution;
static double motorTimeUnit =
    static_cast<double>(1 << 24) / motorfCLK; // t = 2^24/16Mhz

static int acquisitionDisplayLength = 200;
static QVector<double> acquisitionAngleList, acquisitionABSAngleList,
    acquisitionTurnCountList, acquisitionTmp0List, acquisitionTmp1List,
    acquisitionSineList, acquisitionCosineList, acquisitionRadiusList,
    graphDataList, graphPostDataList;

static const QColor scopyBlueColor =
...
static const QColor gpioLEDColor =
    Style::getColor(json::theme::interactive_secondary_idle);
...
static double H1_MAG_ANGLE, H2_MAG_ANGLE, H3_MAG_ANGLE, H8_MAG_ANGLE,
    H1_PHASE_ANGLE, H2_PHASE_ANGLE, H3_PHASE_ANGLE, H8_PHASE_ANGLE;
static uint32_t H1_MAG_HEX, H2_MAG_HEX, H3_MAG_HEX, H8_MAG_HEX, H1_PHASE_HEX,
    H2_PHASE_HEX, H3_PHASE_HEX, H8_PHASE_HEX;
...
static map<AcquisitionDataKey, bool> acquisitionDataMap = {
    {RADIUS, false},   {ANGLE, false},  {TURNCOUNT, false}, {ABSANGLE, false},
    {SINE, false},     {COSINE, false}, {SECANGLI, false},  {SECANGLQ, false},
    {ANGLESEC, false}, {DIAG1, false},  {DIAG2, false},     {TMP0, false},
    {TMP1, false},     {CNVCNT, false}, {SCRADIUS, false},  {SPIFAULT, false}};

HarmonicCalibration::HarmonicCalibration(ADMTController *m_admtController,
                                         bool isDebug, QWidget *parent)
    : QWidget(parent), isDebug(isDebug), m_admtController(m_admtController) {
  ...
  rotationChannelName =
      m_admtController->getChannelId(ADMTController::Channel::ROTATION);
  angleChannelName =
      m_admtController->getChannelId(ADMTController::Channel::ANGLE);
  countChannelName =
      m_admtController->getChannelId(ADMTController::Channel::COUNT);
  temperatureChannelName =
      m_admtController->getChannelId(ADMTController::Channel::TEMPERATURE);
  ...
  connect(this, &HarmonicCalibration::updateFaultStatusSignal, this,
          &HarmonicCalibration::updateFaultStatus);
  connect(this, &HarmonicCalibration::motorPositionChanged, this,
          &HarmonicCalibration::updateMotorPosition);

  connect(this, &HarmonicCalibration::calibrationLogWriteSignal, this,
          &HarmonicCalibration::calibrationLogWrite);
  connect(this, &HarmonicCalibration::commandLogWriteSignal, this,
          &HarmonicCalibration::commandLogWrite);
  connect(this, &HarmonicCalibration::DIGIORegisterChanged, this,
          &HarmonicCalibration::updateDIGIOUI);
  connect(this, &HarmonicCalibration::FaultRegisterChanged, this,
  ...
  connect(this, &HarmonicCalibration::DIAG2RegisterChanged, this,
          &HarmonicCalibration::updateMTDiagnosticsUI);
...
ToolTemplate *HarmonicCalibration::createAcquisitionWidget() {
  ...
  openLastMenuButton = new OpenLastMenuBtn(
      dynamic_cast<MenuHAnim *>(tool->rightContainer()), true, this);
  rightMenuButtonGroup =
      dynamic_cast<OpenLastMenuBtn *>(openLastMenuButton)->getButtonGroup();
  ...
  connect(resetGMRButton, &QPushButton::clicked, this,
          &HarmonicCalibration::GMRReset);
...
#pragma region Raw Data Widget
  ...
  MenuCollapseSection *rotationSection = new MenuCollapseSection(
      "ABS Angle", MenuCollapseSection::MHCW_NONE,
      MenuCollapseSection::MenuHeaderWidgetType::MHW_BASEWIDGET,
      rotationWidget);
  MenuCollapseSection *angleSection = new MenuCollapseSection(
      "Angle", MenuCollapseSection::MHCW_NONE,
      MenuCollapseSection::MenuHeaderWidgetType::MHW_BASEWIDGET, angleWidget);
  MenuCollapseSection *countSection = new MenuCollapseSection(
      "Count", MenuCollapseSection::MHCW_NONE,
      MenuCollapseSection::MenuHeaderWidgetType::MHW_BASEWIDGET, countWidget);
  MenuCollapseSection *tempSection = new MenuCollapseSection(
      "Temp 0", MenuCollapseSection::MHCW_NONE,
...
#pragma region Acquisition Motor Control Section Widget
  MenuSectionWidget *motorControlSectionWidget =
      new MenuSectionWidget(rawDataWidget);
  Style::setStyle(motorControlSectionWidget,
                  style::properties::widget::basicComponent);
  MenuCollapseSection *motorControlCollapseSection = new MenuCollapseSection(
      "Motor Control", MenuCollapseSection::MHCW_NONE,
      MenuCollapseSection::MenuHeaderWidgetType::MHW_BASEWIDGET,
      motorControlSectionWidget);
  motorControlSectionWidget->contentLayout()->addWidget(
  ...
  acquisitionMotorRPMLineEdit =
      new QLineEdit(QString::number(motor_rpm), motorRPMWidget);
  ...
  QLabel *currentPositionLabel =
      new QLabel("Current Position", currentPositionWidget);
  acquisitionMotorCurrentPositionLineEdit =
      new QLineEdit("--.--", currentPositionWidget);
  ...
  QLabel *targetPositionLabel =
      new QLabel("Target Position", targetPositionWidget);
  motorTargetPositionLineEdit =
      new QLineEdit(QString::number(target_pos), targetPositionWidget);
  ...
  QLabel *motorDirectionLabel =
      new QLabel("Rotation Direction", motorDirectionWidget);
  acquisitionMotorDirectionSwitch =
      new CustomSwitch("CW", "CCW", motorControlSectionWidget);
  ...
  QPushButton *continuousRotationButton =
      new QPushButton("Continuous Rotation", motorControlSectionWidget);
  StyleHelper::BasicButton(continuousRotationButton);
  connect(continuousRotationButton, &QPushButton::clicked, this,
          &HarmonicCalibration::moveMotorContinuous);

  QPushButton *stopMotorButton =
      new QPushButton("Stop Motor", motorControlSectionWidget);
  StyleHelper::BasicButton(stopMotorButton);
  connect(stopMotorButton, &QPushButton::clicked, this,
          &HarmonicCalibration::stopMotor);
  ...
  motorControlCollapseSection->contentLayout()->addWidget(
...
#pragma region Acquisition Graph Section Widget
  MenuSectionWidget *acquisitionGraphSectionWidget =
      new MenuSectionWidget(this);
  Style::setStyle(acquisitionGraphSectionWidget,
                  style::properties::widget::basicComponent);
  MenuCollapseSection *acquisitionGraphCollapseSection =
      new MenuCollapseSection(
          "Captured Data", MenuCollapseSection::MHCW_NONE,
          MenuCollapseSection::MenuHeaderWidgetType::MHW_BASEWIDGET,
          acquisitionGraphSectionWidget);
  acquisitionGraphSectionWidget->setSizePolicy(QSizePolicy::MinimumExpanding,
                                               QSizePolicy::MinimumExpanding);
  acquisitionGraphSectionWidget->contentLayout()->addWidget(
      acquisitionGraphCollapseSection);
  acquisitionGraphCollapseSection->contentLayout()->setSpacing(8);

  acquisitionGraphPlotWidget = new PlotWidget();
  acquisitionGraphPlotWidget->setSizePolicy(QSizePolicy::MinimumExpanding,
                                            QSizePolicy::MinimumExpanding);

  acquisitionXPlotAxis = new PlotAxis(
      QwtAxis::XBottom, acquisitionGraphPlotWidget,
      QPen(Style::getColor(json::theme::interactive_primary_idle)));
  acquisitionXPlotAxis->setInterval(0, acquisitionDisplayLength);
  acquisitionYPlotAxis = new PlotAxis(
      QwtAxis::YLeft, acquisitionGraphPlotWidget,
      QPen(Style::getColor(json::theme::interactive_primary_idle)));
  acquisitionYPlotAxis->setInterval(0, 360);

  acquisitionAnglePlotChannel = new PlotChannel(
      "Angle", channel0Pen, acquisitionXPlotAxis, acquisitionYPlotAxis);
  acquisitionABSAnglePlotChannel = new PlotChannel(
      "ABS Angle", channel1Pen, acquisitionXPlotAxis, acquisitionYPlotAxis);
  acquisitionTurnCountPlotChannel = new PlotChannel(
      "Turn Count", channel2Pen, acquisitionXPlotAxis, acquisitionYPlotAxis);
  acquisitionTmp0PlotChannel = new PlotChannel(
      "TMP 0", channel3Pen, acquisitionXPlotAxis, acquisitionYPlotAxis);
  acquisitionTmp1PlotChannel = new PlotChannel(
      "TMP 1", channel4Pen, acquisitionXPlotAxis, acquisitionYPlotAxis);
  acquisitionSinePlotChannel = new PlotChannel(
      "Sine", sinePen, acquisitionXPlotAxis, acquisitionYPlotAxis);
  acquisitionCosinePlotChannel = new PlotChannel(
      "Cosine", cosinePen, acquisitionXPlotAxis, acquisitionYPlotAxis);
  acquisitionRadiusPlotChannel = new PlotChannel(
      "Radius", channel5Pen, acquisitionXPlotAxis, acquisitionYPlotAxis);
  acquisitionSecAnglQPlotChannel = new PlotChannel(
      "SECANGLQ", channel6Pen, acquisitionXPlotAxis, acquisitionYPlotAxis);
  acquisitionSecAnglIPlotChannel = new PlotChannel(
      "SECANGLI", channel7Pen, acquisitionXPlotAxis, acquisitionYPlotAxis);
...
#pragma region Channel Selection
  QWidget *acquisitionGraphChannelWidget =
      new QWidget(acquisitionGraphSectionWidget);
  QGridLayout *acquisitionGraphChannelGridLayout =
      new QGridLayout(acquisitionGraphChannelWidget);
  ...
  QCheckBox *angleCheckBox =
      new QCheckBox("Angle", acquisitionGraphChannelWidget);
  ADMTStyleHelper::ColoredSquareCheckbox(angleCheckBox, channel0Pen.color());
  connectCheckBoxToAcquisitionGraph(angleCheckBox, acquisitionAnglePlotChannel,
                                    ANGLE);
  angleCheckBox->setChecked(true);

  QCheckBox *absAngleCheckBox =
      new QCheckBox("ABS Angle", acquisitionGraphChannelWidget);
  ADMTStyleHelper::ColoredSquareCheckbox(absAngleCheckBox, channel1Pen.color());
  connectCheckBoxToAcquisitionGraph(absAngleCheckBox,
                                    acquisitionABSAnglePlotChannel, ABSANGLE);

  QCheckBox *temp0CheckBox =
      new QCheckBox("Temp 0", acquisitionGraphChannelWidget);
  ADMTStyleHelper::ColoredSquareCheckbox(temp0CheckBox, channel3Pen.color());
  connectCheckBoxToAcquisitionGraph(temp0CheckBox, acquisitionTmp0PlotChannel,
                                    TMP0);

  QCheckBox *sineCheckBox =
      new QCheckBox("Sine", acquisitionGraphChannelWidget);
  ADMTStyleHelper::ColoredSquareCheckbox(sineCheckBox, sineColor);
  connectCheckBoxToAcquisitionGraph(sineCheckBox, acquisitionSinePlotChannel,
                                    SINE);

  QCheckBox *cosineCheckBox =
      new QCheckBox("Cosine", acquisitionGraphChannelWidget);
  ADMTStyleHelper::ColoredSquareCheckbox(cosineCheckBox, cosineColor);
  connectCheckBoxToAcquisitionGraph(cosineCheckBox,
                                    acquisitionCosinePlotChannel, COSINE);

  QCheckBox *radiusCheckBox =
      new QCheckBox("Radius", acquisitionGraphChannelWidget);
  ADMTStyleHelper::ColoredSquareCheckbox(radiusCheckBox, channel5Pen.color());
  connectCheckBoxToAcquisitionGraph(radiusCheckBox,
                                    acquisitionRadiusPlotChannel, RADIUS);
...
#pragma endregion
  ...
  acquisitionGraphCollapseSection->contentLayout()->addWidget(
      acquisitionGraphPlotWidget);
  acquisitionGraphCollapseSection->contentLayout()->addWidget(
      acquisitionGraphChannelWidget);
#pragma endregion
...
#pragma region General Setting
  ...
  header =
      new MenuHeaderWidget(deviceName + " " + deviceType, scopyBluePen, this);
  Style::setStyle(header, style::properties::widget::basicComponent);

  // General Setting Widget
  MenuSectionWidget *generalWidget =
      new MenuSectionWidget(generalSettingWidget);
  ...
  MenuCollapseSection *generalSection = new MenuCollapseSection(
      "Data Acquisition", MenuCollapseSection::MHCW_NONE,
  ...
  QVBoxLayout *graphUpdateIntervalLayout =
      new QVBoxLayout(graphUpdateIntervalWidget);
  ...
  graphUpdateIntervalLineEdit->setText(
      QString::number(acquisitionGraphSampleRate));
  connectLineEditToNumber(graphUpdateIntervalLineEdit,
                          acquisitionGraphSampleRate, 1, 5000);
  ...
  QLabel *displayLengthLabel =
      new QLabel("Display Length", displayLengthWidget);
  ...
  connectLineEditToNumber(displayLengthLineEdit, acquisitionDisplayLength, 1,
                          2048);
  displayLengthLayout->addWidget(displayLengthLabel);
  displayLengthLayout->addWidget(displayLengthLineEdit);

  QPushButton *resetYAxisButton =
      new QPushButton("Reset Y-Axis Scale", generalSection);
  StyleHelper::BasicButton(resetYAxisButton);
  connect(resetYAxisButton, &QPushButton::clicked, this,
          &HarmonicCalibration::resetAcquisitionYAxisScale);
  ...
  MenuSectionWidget *sequenceWidget =
      new MenuSectionWidget(generalSettingWidget);
  Style::setStyle(sequenceWidget, style::properties::widget::basicComponent);
  MenuCollapseSection *sequenceSection = new MenuCollapseSection(
      "Sequence", MenuCollapseSection::MHCW_NONE,
      MenuCollapseSection::MenuHeaderWidgetType::MHW_BASEWIDGET,
      sequenceWidget);
  ...
  convertSynchronizationMenuCombo =
      new MenuCombo("Convert Synchronization", sequenceSection);
  QComboBox *convertSynchronizationComboBox =
      convertSynchronizationMenuCombo->combo();
  ...
  connect(applySequenceButton, &QPushButton::clicked, this,
          &HarmonicCalibration::applySequenceAndUpdate);
...
#pragma region Device Status Widget
  MenuSectionWidget *acquisitionDeviceStatusWidget =
      new MenuSectionWidget(generalSettingWidget);
  Style::setStyle(acquisitionDeviceStatusWidget,
                  style::properties::widget::basicComponent);
  MenuCollapseSection *acquisitionDeviceStatusSection = new MenuCollapseSection(
      "Device Status", MenuCollapseSection::MHCW_NONE,
      MenuCollapseSection::MenuHeaderWidgetType::MHW_BASEWIDGET, generalWidget);
  acquisitionDeviceStatusSection->contentLayout()->setSpacing(
      globalSpacingSmall);
  acquisitionDeviceStatusWidget->contentLayout()->addWidget(
      acquisitionDeviceStatusSection);

  acquisitionFaultRegisterLEDWidget = createStatusLEDWidget(
      "Fault Register", "status", false, acquisitionDeviceStatusSection);
  acquisitionDeviceStatusSection->contentLayout()->addWidget(
      acquisitionFaultRegisterLEDWidget);

  if (deviceType == "Automotive" && GENERALRegisterMap.at("Sequence Type") ==
                                        1) // Automotive & Sequence Mode 2
  {
    QCheckBox *acquisitionSPICRCLEDWidget = createStatusLEDWidget(
        "SPI CRC", "status", false, acquisitionDeviceStatusSection);
    QCheckBox *acquisitionSPIFlagLEDWidget = createStatusLEDWidget(
        "SPI Flag", "status", false, acquisitionDeviceStatusSection);
    acquisitionDeviceStatusSection->contentLayout()->addWidget(
        acquisitionSPICRCLEDWidget);
    acquisitionDeviceStatusSection->contentLayout()->addWidget(
...
#pragma endregion
  ...
  connect(runButton, &QPushButton::toggled, this,
          &HarmonicCalibration::setRunning);
  connect(this, &HarmonicCalibration::runningChanged, this,
          &HarmonicCalibration::run);
  connect(this, &HarmonicCalibration::runningChanged, runButton,
...
#pragma region Calibration Data Graph Widget
  ...
  QGridLayout *calibrationDataGraphLayout =
      new QGridLayout(calibrationDataGraphWidget);
  ...
  MenuSectionWidget *calibrationDataGraphSectionWidget =
      new MenuSectionWidget(calibrationDataGraphWidget);
  Style::setStyle(calibrationDataGraphSectionWidget,
                  style::properties::widget::basicComponent);
  calibrationDataGraphTabWidget =
      new QTabWidget(calibrationDataGraphSectionWidget);
  calibrationDataGraphTabWidget->tabBar()->setStyleSheet(
      "QTabBar::tab { width: 176px; }");
  calibrationDataGraphSectionWidget->contentLayout()->setSpacing(8);
  calibrationDataGraphSectionWidget->contentLayout()->addWidget(
      calibrationDataGraphTabWidget);

#pragma region Calibration Samples
  QWidget *calibrationSamplesWidget =
      new QWidget(calibrationDataGraphTabWidget);
  Style::setStyle(calibrationSamplesWidget,
                  style::properties::widget::basicBackground);
  QVBoxLayout *calibrationSamplesLayout =
      new QVBoxLayout(calibrationSamplesWidget);
  ...
  calibrationRawDataXPlotAxis = new PlotAxis(
      QwtAxis::XBottom, calibrationRawDataPlotWidget,
      QPen(Style::getColor(json::theme::interactive_primary_idle)));
  calibrationRawDataXPlotAxis->setMin(0);
  calibrationRawDataYPlotAxis = new PlotAxis(
      QwtAxis::YLeft, calibrationRawDataPlotWidget,
      QPen(Style::getColor(json::theme::interactive_primary_idle)));
  calibrationRawDataYPlotAxis->setInterval(0, 360);

  calibrationRawDataPlotChannel =
      new PlotChannel("Samples", scopyBluePen, calibrationRawDataXPlotAxis,
                      calibrationRawDataYPlotAxis);
  calibrationSineDataPlotChannel =
      new PlotChannel("Sine", sinePen, calibrationRawDataXPlotAxis,
                      calibrationRawDataYPlotAxis);
  calibrationCosineDataPlotChannel =
      new PlotChannel("Cosine", cosinePen, calibrationRawDataXPlotAxis,
                      calibrationRawDataYPlotAxis);
  ...
  calibrationRawDataPlotWidget->addPlotChannel(
      calibrationCosineDataPlotChannel);
  ...
  QWidget *calibrationDataGraphChannelsWidget =
      new QWidget(calibrationDataGraphTabWidget);
  ADMTStyleHelper::UIBackgroundStyle(calibrationDataGraphChannelsWidget);
  QHBoxLayout *calibrationDataGraphChannelsLayout =
      new QHBoxLayout(calibrationDataGraphChannelsWidget);
  calibrationDataGraphChannelsWidget->setLayout(
  ...
  MenuControlButton *toggleAngleButton = createChannelToggleWidget(
      "Angle", scopyBlueColor, calibrationDataGraphChannelsWidget);
  MenuControlButton *toggleSineButton = createChannelToggleWidget(
      "Sine", sineColor, calibrationDataGraphChannelsWidget);
  MenuControlButton *toggleCosineButton = createChannelToggleWidget(
      "Cosine", cosineColor, calibrationDataGraphChannelsWidget);
...
#pragma region Post Calibration Samples
  QWidget *postCalibrationSamplesWidget =
      new QWidget(calibrationDataGraphTabWidget);
  Style::setStyle(postCalibrationSamplesWidget,
                  style::properties::widget::basicBackground);
  QVBoxLayout *postCalibrationSamplesLayout =
      new QVBoxLayout(postCalibrationSamplesWidget);
  ...
  postCalibrationRawDataXPlotAxis = new PlotAxis(
      QwtAxis::XBottom, postCalibrationRawDataPlotWidget,
      QPen(Style::getColor(json::theme::interactive_primary_idle)));
  postCalibrationRawDataXPlotAxis->setMin(0);
  postCalibrationRawDataYPlotAxis = new PlotAxis(
      QwtAxis::YLeft, postCalibrationRawDataPlotWidget,
      QPen(Style::getColor(json::theme::interactive_primary_idle)));
  postCalibrationRawDataYPlotAxis->setInterval(0, 360);

  postCalibrationRawDataPlotChannel =
      new PlotChannel("Samples", scopyBluePen, postCalibrationRawDataXPlotAxis,
                      postCalibrationRawDataYPlotAxis);
  postCalibrationSineDataPlotChannel =
      new PlotChannel("Sine", sinePen, postCalibrationRawDataXPlotAxis,
                      postCalibrationRawDataYPlotAxis);
  postCalibrationCosineDataPlotChannel =
      new PlotChannel("Cosine", cosinePen, postCalibrationRawDataXPlotAxis,
                      postCalibrationRawDataYPlotAxis);

  postCalibrationRawDataPlotWidget->addPlotChannel(
      postCalibrationRawDataPlotChannel);
  postCalibrationRawDataPlotWidget->addPlotChannel(
      postCalibrationSineDataPlotChannel);
  postCalibrationRawDataPlotWidget->addPlotChannel(
  ...
  postCalibrationRawDataPlotWidget->selectChannel(
      postCalibrationRawDataPlotChannel);
  ...
  QWidget *postCalibrationDataGraphChannelsWidget =
      new QWidget(calibrationDataGraphTabWidget);
  QHBoxLayout *postCalibrationDataGraphChannelsLayout =
      new QHBoxLayout(postCalibrationDataGraphChannelsWidget);
  ADMTStyleHelper::GraphChannelStyle(postCalibrationDataGraphChannelsWidget,
                                     postCalibrationDataGraphChannelsLayout);

  MenuControlButton *togglePostAngleButton = createChannelToggleWidget(
      "Angle", scopyBlueColor, postCalibrationDataGraphChannelsWidget);
  MenuControlButton *togglePostSineButton = createChannelToggleWidget(
      "Sine", sineColor, postCalibrationDataGraphChannelsWidget);
  MenuControlButton *togglePostCosineButton = createChannelToggleWidget(
      "Cosine", cosineColor, postCalibrationDataGraphChannelsWidget);
  ...
  postCalibrationSamplesLayout->addWidget(
      postCalibrationDataGraphChannelsWidget);
#pragma endregion

  calibrationDataGraphTabWidget->addTab(calibrationSamplesWidget,
                                        "Calibration Samples");
  calibrationDataGraphTabWidget->addTab(postCalibrationSamplesWidget,
                                        "Post Calibration Samples");

  MenuSectionWidget *resultDataSectionWidget =
      new MenuSectionWidget(calibrationDataGraphWidget);
  Style::setStyle(resultDataSectionWidget,
                  style::properties::widget::basicComponent);
  resultDataTabWidget = new QTabWidget(resultDataSectionWidget);
  resultDataTabWidget->tabBar()->setStyleSheet(
      "QTabBar::tab { width: 160px; }");
...
#pragma region Angle Error Widget
  ...
  angleErrorXPlotAxis = new PlotAxis(
      QwtAxis::XBottom, angleErrorPlotWidget,
      QPen(Style::getColor(json::theme::interactive_primary_idle)));
  angleErrorXPlotAxis->setMin(0);
  angleErrorYPlotAxis = new PlotAxis(
      QwtAxis::YLeft, angleErrorPlotWidget,
      QPen(Style::getColor(json::theme::interactive_primary_idle)));
  angleErrorYPlotAxis->setInterval(-4, 4);

  angleErrorPlotChannel = new PlotChannel(
      "Angle Error", scopyBluePen, angleErrorXPlotAxis, angleErrorYPlotAxis);
...
#pragma region FFT Angle Error Widget
  ...
  Style::setStyle(FFTAngleErrorWidget,
                  style::properties::widget::basicBackground);
  ...
  FFTAngleErrorXPlotAxis = new PlotAxis(
      QwtAxis::XBottom, FFTAngleErrorPlotWidget,
      QPen(Style::getColor(json::theme::interactive_primary_idle)));
  FFTAngleErrorXPlotAxis->setMin(0);
  FFTAngleErrorYPlotAxis = new PlotAxis(
      QwtAxis::YLeft, FFTAngleErrorPlotWidget,
      QPen(Style::getColor(json::theme::interactive_primary_idle)));
  FFTAngleErrorYPlotAxis->setInterval(-4, 4);

  FFTAngleErrorMagnitudeChannel =
      new PlotChannel("FFT Angle Error Magnitude", magnitudePen,
                      FFTAngleErrorXPlotAxis, FFTAngleErrorYPlotAxis);
  FFTAngleErrorPhaseChannel =
      new PlotChannel("FFT Angle Error Phase", phasePen, FFTAngleErrorXPlotAxis,
                      FFTAngleErrorYPlotAxis);
  ...
  QHBoxLayout *FFTAngleErrorChannelsLayout =
      new QHBoxLayout(FFTAngleErrorChannelsWidget);
  ADMTStyleHelper::GraphChannelStyle(FFTAngleErrorChannelsWidget,
                                     FFTAngleErrorChannelsLayout);

  MenuControlButton *toggleFFTAngleErrorMagnitudeButton =
      createChannelToggleWidget("Magnitude", magnitudeColor,
                                FFTAngleErrorChannelsWidget);
  MenuControlButton *toggleFFTAngleErrorPhaseButton = createChannelToggleWidget(
      "Phase", phaseColor, FFTAngleErrorChannelsWidget);
...
#pragma region Corrected Error Widget
  ...
  Style::setStyle(correctedErrorWidget,
                  style::properties::widget::basicBackground);
  ...
  correctedErrorXPlotAxis = new PlotAxis(
      QwtAxis::XBottom, correctedErrorPlotWidget,
      QPen(Style::getColor(json::theme::interactive_primary_idle)));
  correctedErrorXPlotAxis->setMin(0);
  correctedErrorYPlotAxis = new PlotAxis(
      QwtAxis::YLeft, correctedErrorPlotWidget,
      QPen(Style::getColor(json::theme::interactive_primary_idle)));
  correctedErrorYPlotAxis->setInterval(-4, 4);

  correctedErrorPlotChannel =
      new PlotChannel("Corrected Error", scopyBluePen, correctedErrorXPlotAxis,
                      correctedErrorYPlotAxis);
...
#pragma region FFT Corrected Error Widget
  ...
  Style::setStyle(FFTCorrectedErrorWidget,
                  style::properties::widget::basicBackground);
  ...
  FFTCorrectedErrorXPlotAxis = new PlotAxis(
      QwtAxis::XBottom, FFTCorrectedErrorPlotWidget,
      QPen(Style::getColor(json::theme::interactive_primary_idle)));
  FFTCorrectedErrorXPlotAxis->setMin(0);
  FFTCorrectedErrorYPlotAxis = new PlotAxis(
      QwtAxis::YLeft, FFTCorrectedErrorPlotWidget,
      QPen(Style::getColor(json::theme::interactive_primary_idle)));
  FFTCorrectedErrorYPlotAxis->setInterval(-4, 4);

  FFTCorrectedErrorMagnitudeChannel =
      new PlotChannel("FFT Corrected Error Magnitude", magnitudePen,
                      FFTCorrectedErrorXPlotAxis, FFTCorrectedErrorYPlotAxis);
  FFTCorrectedErrorPhaseChannel =
      new PlotChannel("FFT Corrected Error Phase", phasePen,
                      FFTCorrectedErrorXPlotAxis, FFTCorrectedErrorYPlotAxis);
  FFTCorrectedErrorPlotWidget->addPlotChannel(
      FFTCorrectedErrorMagnitudeChannel);
  ...
  QHBoxLayout *FFTCorrectedErrorChannelsLayout =
      new QHBoxLayout(FFTCorrectedErrorChannelsWidget);
  ADMTStyleHelper::GraphChannelStyle(FFTCorrectedErrorChannelsWidget,
                                     FFTCorrectedErrorChannelsLayout);

  MenuControlButton *toggleFFTCorrectedErrorMagnitudeButton =
      createChannelToggleWidget("Magnitude", magnitudeColor,
                                FFTCorrectedErrorChannelsWidget);
  MenuControlButton *toggleFFTCorrectedErrorPhaseButton =
      createChannelToggleWidget("Phase", phaseColor,
                                FFTCorrectedErrorChannelsWidget);

  FFTCorrectedErrorChannelsLayout->addWidget(
      toggleFFTCorrectedErrorMagnitudeButton);
  FFTCorrectedErrorChannelsLayout->addWidget(
      toggleFFTCorrectedErrorPhaseButton);
...
#pragma endregion
  ...
  calibrationDataGraphLayout->addWidget(calibrationDataGraphSectionWidget, 0,
                                        0);
...
#pragma region Calibration Settings Widget
  ...
  QVBoxLayout *calibrationSettingsGroupLayout =
      new QVBoxLayout(calibrationSettingsGroupWidget);
...
#pragma region Device Status Widget
  MenuSectionWidget *calibrationDeviceStatusWidget =
      new MenuSectionWidget(calibrationSettingsGroupWidget);
  Style::setStyle(calibrationDeviceStatusWidget,
                  style::properties::widget::basicComponent);
  ...
  MenuCollapseSection *calibrationDeviceStatusSection = new MenuCollapseSection(
      "Device Status", MenuCollapseSection::MHCW_NONE,
      MenuCollapseSection::MenuHeaderWidgetType::MHW_BASEWIDGET,
      calibrationSettingsGroupWidget);
  calibrationDeviceStatusSection->contentLayout()->setSpacing(8);
  calibrationDeviceStatusWidget->contentLayout()->addWidget(
      calibrationDeviceStatusSection);

  calibrationFaultRegisterLEDWidget = createStatusLEDWidget(
      "Fault Register", "status", false, calibrationDeviceStatusSection);
  calibrationDeviceStatusSection->contentLayout()->addWidget(
      calibrationFaultRegisterLEDWidget);

  if (deviceType == "Automotive" && GENERALRegisterMap.at("Sequence Type") ==
                                        1) // Automotive & Sequence Mode 2
  {
    QCheckBox *calibrationSPICRCLEDWidget = createStatusLEDWidget(
        "SPI CRC", "status", false, calibrationDeviceStatusSection);
    QCheckBox *calibrationSPIFlagLEDWidget = createStatusLEDWidget(
        "SPI Flag", "status", false, calibrationDeviceStatusSection);
    calibrationDeviceStatusSection->contentLayout()->addWidget(
        calibrationSPICRCLEDWidget);
    calibrationDeviceStatusSection->contentLayout()->addWidget(
        calibrationSPIFlagLEDWidget);
  }
#pragma endregion
...
#pragma region Acquire Calibration Samples Button
  ...
  Style::setStyle(calibrationStartMotorButton,
                  style::properties::admt::fullWidthRunButton);
  calibrationStartMotorButton->setCheckable(true);
  calibrationStartMotorButton->setChecked(false);
  QIcon icon1;
  icon1.addPixmap(
      Style::getPixmap(":/gui/icons/play.svg",
                       Style::getColor(json::theme::content_inverse)),
      QIcon::Normal, QIcon::Off);
  icon1.addPixmap(
      Style::getPixmap(":/gui/icons/" +
  ...
  connect(calibrationStartMotorButton, &QPushButton::toggled, this,
          [this](bool toggled) {
            calibrationStartMotorButton->setText(toggled ? " Stop Acquisition"
                                                         : " Acquire Samples");
...
#pragma region Start Calibration Button
  calibrateDataButton =
      new QPushButton(" Calibrate", calibrationSettingsGroupWidget);
  Style::setStyle(calibrateDataButton,
                  style::properties::admt::fullWidthRunButton);
...
#pragma region Reset Calibration Button
  clearCalibrateDataButton =
      new QPushButton("Reset Calibration", calibrationSettingsGroupWidget);
  ...
  resetIcon.addPixmap(
      Style::getPixmap(":/gui/icons/refresh.svg",
                       Style::getColor(json::theme::content_inverse)),
      QIcon::Normal, QIcon::Off);
...
#pragma endregion
  ...
  QWidget *calibrationSettingsWidget =
      new QWidget(calibrationSettingsScrollArea);
  QVBoxLayout *calibrationSettingsLayout =
      new QVBoxLayout(calibrationSettingsWidget);
...
#pragma region Calibration Coefficient Section Widget
  MenuSectionWidget *calibrationCoeffSectionWidget =
      new MenuSectionWidget(calibrationSettingsWidget);
  Style::setStyle(calibrationCoeffSectionWidget,
                  style::properties::widget::basicComponent);
  QLabel *calibrationDisplayFormatLabel =
      new QLabel(calibrationCoeffSectionWidget);
  calibrationDisplayFormatLabel->setText("Display Format");
  Style::setStyle(calibrationDisplayFormatLabel,
                  style::properties::label::menuMedium);
  QLabel *calibrationCalculatedCoeffLabel =
      new QLabel(calibrationCoeffSectionWidget);
  calibrationCalculatedCoeffLabel->setText("Calculated Coefficients");
  Style::setStyle(calibrationCalculatedCoeffLabel,
                  style::properties::label::menuMedium);
  ...
  QWidget *calibrationCalculatedCoeffWidget =
      new QWidget(calibrationCoeffSectionWidget);
  QGridLayout *calibrationCalculatedCoeffLayout =
      new QGridLayout(calibrationCalculatedCoeffWidget);
  ...
  Style::setStyle(calibrationCalculatedCoeffWidget,
                  style::properties::widget::basicBackground);
  ...
  QLabel *calibrationH1Label =
      new QLabel("H1", calibrationCalculatedCoeffWidget);
  calibrationH1MagLabel =
      new QLabel("0x----", calibrationCalculatedCoeffWidget);
  calibrationH1PhaseLabel =
      new QLabel("0x----", calibrationCalculatedCoeffWidget);
  ADMTStyleHelper::CalculatedCoeffWidgetRowStyle(
      h1RowContainer, h1RowLayout, calibrationH1Label, calibrationH1MagLabel,
      calibrationH1PhaseLabel);
  ...
  QLabel *calibrationH2Label =
      new QLabel("H2", calibrationCalculatedCoeffWidget);
  calibrationH2MagLabel =
      new QLabel("0x----", calibrationCalculatedCoeffWidget);
  calibrationH2PhaseLabel =
      new QLabel("0x----", calibrationCalculatedCoeffWidget);
  ADMTStyleHelper::CalculatedCoeffWidgetRowStyle(
      h2RowContainer, h2RowLayout, calibrationH2Label, calibrationH2MagLabel,
      calibrationH2PhaseLabel);
  ...
  QLabel *calibrationH3Label =
      new QLabel("H3", calibrationCalculatedCoeffWidget);
  calibrationH3MagLabel =
      new QLabel("0x----", calibrationCalculatedCoeffWidget);
  calibrationH3PhaseLabel =
      new QLabel("0x----", calibrationCalculatedCoeffWidget);
  ADMTStyleHelper::CalculatedCoeffWidgetRowStyle(
      h3RowContainer, h3RowLayout, calibrationH3Label, calibrationH3MagLabel,
      calibrationH3PhaseLabel);
  ...
  QLabel *calibrationH8Label =
      new QLabel("H8", calibrationCalculatedCoeffWidget);
  calibrationH8MagLabel =
      new QLabel("0x----", calibrationCalculatedCoeffWidget);
  calibrationH8PhaseLabel =
      new QLabel("0x----", calibrationCalculatedCoeffWidget);
  ADMTStyleHelper::CalculatedCoeffWidgetRowStyle(
      h8RowContainer, h8RowLayout, calibrationH8Label, calibrationH8MagLabel,
      calibrationH8PhaseLabel);
  ...
  calibrationCoeffSectionWidget->contentLayout()->addWidget(
      calibrationDisplayFormatLabel);
  calibrationCoeffSectionWidget->contentLayout()->addWidget(
      calibrationDisplayFormatSwitch);
  calibrationCoeffSectionWidget->contentLayout()->addWidget(
...
#pragma region Calibration Dataset Configuration
  MenuSectionWidget *calibrationDatasetConfigSectionWidget =
      new MenuSectionWidget(calibrationSettingsWidget);
  Style::setStyle(calibrationDatasetConfigSectionWidget,
                  style::properties::widget::basicComponent);
  MenuCollapseSection *calibrationDatasetConfigCollapseSection =
      new MenuCollapseSection(
          "Dataset Configuration",
          MenuCollapseSection::MenuHeaderCollapseStyle::MHCW_NONE,
          MenuCollapseSection::MenuHeaderWidgetType::MHW_BASEWIDGET,
          calibrationDatasetConfigSectionWidget);
  calibrationDatasetConfigSectionWidget->contentLayout()->setSpacing(8);
  calibrationDatasetConfigSectionWidget->contentLayout()->addWidget(
      calibrationDatasetConfigCollapseSection);

#pragma region Continuous Calibration Toggle
  calibrationModeMenuCombo = new MenuCombo(
      "Calibration Mode", calibrationDatasetConfigCollapseSection);
...
#pragma endregion
  ...
  QWidget *calibrationCycleCountWidget =
      new QWidget(calibrationDatasetConfigCollapseSection);
  QVBoxLayout *calibrationCycleCountLayout =
      new QVBoxLayout(calibrationCycleCountWidget);
  ...
  QLabel *calibrationCycleCountLabel =
      new QLabel("Cycle Count", calibrationCycleCountWidget);
  QLineEdit *calibrationCycleCountLineEdit =
      new QLineEdit(calibrationCycleCountWidget);
  ...
  QWidget *calibrationSamplesPerCycleWidget =
      new QWidget(calibrationDatasetConfigCollapseSection);
  QVBoxLayout *calibrationSamplesPerCycleLayout =
      new QVBoxLayout(calibrationSamplesPerCycleWidget);
  ...
  QLabel *calibrationSamplesPerCycleLabel =
      new QLabel("Samples Per Cycle", calibrationSamplesPerCycleWidget);
  QLineEdit *calibrationSamplesPerCycleLineEdit =
      new QLineEdit(calibrationSamplesPerCycleWidget);
  ...
  calibrationSamplesPerCycleLayout->addWidget(
      calibrationSamplesPerCycleLineEdit);

  calibrationDatasetConfigCollapseSection->contentLayout()->setSpacing(8);
  calibrationDatasetConfigCollapseSection->contentLayout()->addWidget(
...
#pragma region Calibration Data Section Widget
  MenuSectionWidget *calibrationDataSectionWidget =
      new MenuSectionWidget(calibrationSettingsWidget);
  Style::setStyle(calibrationDataSectionWidget,
                  style::properties::widget::basicComponent);
  MenuCollapseSection *calibrationDataCollapseSection = new MenuCollapseSection(
      "Calibration Data",
      MenuCollapseSection::MenuHeaderCollapseStyle::MHCW_NONE,
      MenuCollapseSection::MenuHeaderWidgetType::MHW_BASEWIDGET,
      calibrationDataSectionWidget);
  calibrationDataSectionWidget->contentLayout()->setSpacing(8);
  calibrationDataSectionWidget->contentLayout()->addWidget(
      calibrationDataCollapseSection);

  QPushButton *importSamplesButton =
      new QPushButton("Import Samples", calibrationDataCollapseSection);
  QPushButton *extractDataButton =
      new QPushButton("Save to CSV", calibrationDataCollapseSection);
  ...
  calibrationDataCollapseSection->contentLayout()->addWidget(
      importSamplesButton);
...
#pragma region Motor Control Section Widget
  ...
  QLabel *motorDirectionLabel =
      new QLabel("Rotation Direction", motorDirectionWidget);
  calibrationMotorDirectionSwitch =
      new CustomSwitch("CW", "CCW", motorControlSectionWidget);
...
#pragma region Logs Section Widget
  MenuSectionWidget *logsSectionWidget =
      new MenuSectionWidget(calibrationSettingsWidget);
  Style::setStyle(logsSectionWidget, style::properties::widget::basicComponent);
  MenuCollapseSection *logsCollapseSection = new MenuCollapseSection(
      "Logs", MenuCollapseSection::MHCW_NONE,
      MenuCollapseSection::MenuHeaderWidgetType::MHW_BASEWIDGET,
      logsSectionWidget);
...
#pragma endregion
  ...
  calibrationSettingsLayout->addSpacerItem(
...
#pragma endregion
  ...
  tool->rightStack()->add("calibrationSettingsGroupWidget",
                          calibrationSettingsGroupWidget);

  connect(extractDataButton, &QPushButton::clicked, this,
          &HarmonicCalibration::extractCalibrationData);
  connect(importSamplesButton, &QPushButton::clicked, this,
          &HarmonicCalibration::importCalibrationData);
  connect(clearCalibrateDataButton, &QPushButton::clicked, this,
          &HarmonicCalibration::resetAllCalibrationState);
  connect(toggleAngleButton->checkBox(), &QCheckBox::toggled, this,
          [this](bool b) {
            calibrationRawDataPlotWidget->selectChannel(
                calibrationRawDataPlotChannel);
  ...
  connect(toggleCosineButton->checkBox(), &QCheckBox::toggled, this,
          [this](bool b) {
            calibrationRawDataPlotWidget->selectChannel(
                calibrationCosineDataPlotChannel);
            calibrationRawDataPlotWidget->selectedChannel()->setEnabled(b);
          });
  connect(togglePostAngleButton->checkBox(), &QCheckBox::toggled, this,
          [this](bool b) {
            postCalibrationRawDataPlotWidget->selectChannel(
                postCalibrationRawDataPlotChannel);
            postCalibrationRawDataPlotWidget->selectedChannel()->setEnabled(b);
          });
  connect(togglePostSineButton->checkBox(), &QCheckBox::toggled, this,
          [this](bool b) {
            postCalibrationRawDataPlotWidget->selectChannel(
                postCalibrationSineDataPlotChannel);
            postCalibrationRawDataPlotWidget->selectedChannel()->setEnabled(b);
          });
  connect(togglePostCosineButton->checkBox(), &QCheckBox::toggled, this,
          [this](bool b) {
            postCalibrationRawDataPlotWidget->selectChannel(
                postCalibrationCosineDataPlotChannel);
            postCalibrationRawDataPlotWidget->selectedChannel()->setEnabled(b);
          });
  connect(toggleFFTAngleErrorMagnitudeButton->checkBox(), &QCheckBox::toggled,
          this, [this](bool b) {
            FFTAngleErrorPlotWidget->selectChannel(
                FFTAngleErrorMagnitudeChannel);
            FFTAngleErrorPlotWidget->selectedChannel()->setEnabled(b);
          });
  connect(toggleFFTAngleErrorPhaseButton->checkBox(), &QCheckBox::toggled, this,
          [this](bool b) {
            FFTAngleErrorPlotWidget->selectChannel(FFTAngleErrorPhaseChannel);
            FFTAngleErrorPlotWidget->selectedChannel()->setEnabled(b);
          });
  connect(toggleFFTCorrectedErrorMagnitudeButton->checkBox(),
          &QCheckBox::toggled, this, [this](bool b) {
            FFTCorrectedErrorPlotWidget->selectChannel(
                FFTCorrectedErrorMagnitudeChannel);
            FFTCorrectedErrorPlotWidget->selectedChannel()->setEnabled(b);
          });
  connect(toggleFFTCorrectedErrorPhaseButton->checkBox(), &QCheckBox::toggled,
          this, [this](bool b) {
            FFTCorrectedErrorPlotWidget->selectChannel(
                FFTCorrectedErrorPhaseChannel);
            FFTCorrectedErrorPlotWidget->selectedChannel()->setEnabled(b);
          });
  connect(calibrationDisplayFormatSwitch, &CustomSwitch::toggled, this,
          [this](bool b) {
            isAngleDisplayFormat = b;
            displayCalculatedCoeff();
          });

  connect(&m_calibrationWaitVelocityWatcher, &QFutureWatcher<void>::finished,
          this, [this]() {
  ...
  connect(&m_calibrationStreamWatcher, &QFutureWatcher<void>::finished, this,
          [this]() {
            ...
            if (isPostCalibration) {
              ...
              postCalibrationRawDataPlotChannel->curve()->setSamples(
                  graphPostDataList);
              postCalibrationRawDataPlotWidget->replot();
              if (static_cast<int>(graphPostDataList.size()) ==
                  totalSamplesCount) {
                computeSineCosineOfAngles(graphPostDataList);
                m_admtController->postcalibrate(
                    vector<double>(graphPostDataList.begin(),
                                   graphPostDataList.end()),
                    cycleCount, samplesPerCycle, !isMotorRotationClockwise);
              ...
              if (static_cast<int>(graphDataList.size()) >= totalSamplesCount) {
                ...
                calibrationLogWrite(m_admtController->calibrate(
                    vector<double>(graphDataList.begin(), graphDataList.end()),
                    cycleCount, samplesPerCycle, !isMotorRotationClockwise));
...
ToolTemplate *HarmonicCalibration::createRegistersWidget() {
  ...
  registerWidget->setContentsMargins(
      0, 0, Style::getDimension(json::global::unit_0_5), 0);
  ...
  MenuCollapseSection *registerConfigurationCollapseSection =
      new MenuCollapseSection(
          "Configuration", MenuCollapseSection::MHCW_ARROW,
          MenuCollapseSection::MenuHeaderWidgetType::MHW_BASEWIDGET,
          registerWidget);
  QWidget *registerConfigurationGridWidget = new QWidget(registerWidget);
  QGridLayout *registerConfigurationGridLayout =
      new QGridLayout(registerConfigurationGridWidget);
  ...
  registerConfigurationCollapseSection->contentLayout()->addWidget(
      registerConfigurationGridWidget);

  MenuCollapseSection *registerSensorDataCollapseSection =
      new MenuCollapseSection(
          "Sensor Data", MenuCollapseSection::MHCW_ARROW,
          MenuCollapseSection::MenuHeaderWidgetType::MHW_BASEWIDGET,
          registerWidget);
  QWidget *registerSensorDataGridWidget = new QWidget(registerWidget);
  QGridLayout *registerSensorDataGridLayout =
      new QGridLayout(registerSensorDataGridWidget);
  ...
  registerSensorDataCollapseSection->contentLayout()->addWidget(
      registerSensorDataGridWidget);

  MenuCollapseSection *registerDeviceIDCollapseSection =
      new MenuCollapseSection(
          "Device ID", MenuCollapseSection::MHCW_ARROW,
          MenuCollapseSection::MenuHeaderWidgetType::MHW_BASEWIDGET,
          registerWidget);
  QWidget *registerDeviceIDGridWidget = new QWidget(registerWidget);
  QGridLayout *registerDeviceIDGridLayout =
      new QGridLayout(registerDeviceIDGridWidget);
  ...
  registerDeviceIDCollapseSection->contentLayout()->addWidget(
      registerDeviceIDGridWidget);

  MenuCollapseSection *registerHarmonicsCollapseSection =
      new MenuCollapseSection(
          "Harmonics", MenuCollapseSection::MHCW_ARROW,
          MenuCollapseSection::MenuHeaderWidgetType::MHW_BASEWIDGET,
          registerWidget);
  QWidget *registerHarmonicsGridWidget = new QWidget(registerWidget);
  QGridLayout *registerHarmonicsGridLayout =
      new QGridLayout(registerHarmonicsGridWidget);
  ...
  registerHarmonicsCollapseSection->contentLayout()->addWidget(
  ...
  cnvPageRegisterBlock = new RegisterBlockWidget(
      ...
      m_admtController->getConfigurationRegister(
          ADMTController::ConfigurationRegister::CNVPAGE),
      m_admtController->getConfigurationPage(
          ADMTController::ConfigurationRegister::CNVPAGE),
  ...
  digIORegisterBlock = new RegisterBlockWidget(
      ...
      m_admtController->getConfigurationRegister(
          ADMTController::ConfigurationRegister::DIGIO),
      m_admtController->getConfigurationPage(
          ADMTController::ConfigurationRegister::DIGIO),
      RegisterBlockWidget::ACCESS_PERMISSION::READWRITE, registerWidget);
  ...
  angleCkRegisterBlock = new RegisterBlockWidget(
      ...
      m_admtController->getConfigurationRegister(
          ADMTController::ConfigurationRegister::ANGLECK),
      m_admtController->getConfigurationPage(
          ADMTController::ConfigurationRegister::ANGLECK),
      RegisterBlockWidget::ACCESS_PERMISSION::READWRITE, registerWidget);
  eccDcdeRegisterBlock = new RegisterBlockWidget(
      ...
      m_admtController->getConfigurationRegister(
          ADMTController::ConfigurationRegister::ECCDCDE),
      m_admtController->getConfigurationPage(
          ADMTController::ConfigurationRegister::ECCDCDE),
      RegisterBlockWidget::ACCESS_PERMISSION::READWRITE, registerWidget);
  eccDisRegisterBlock = new RegisterBlockWidget(
      ...
      m_admtController->getConfigurationRegister(
          ADMTController::ConfigurationRegister::ECCDIS),
      m_admtController->getConfigurationPage(
          ADMTController::ConfigurationRegister::ECCDIS),
      RegisterBlockWidget::ACCESS_PERMISSION::READWRITE, registerWidget);

  absAngleRegisterBlock = new RegisterBlockWidget(
      "ABSANGLE", "Absolute Angle",
      m_admtController->getSensorRegister(
          ADMTController::SensorRegister::ABSANGLE),
  ...
  angleRegisterBlock = new RegisterBlockWidget(
      "ANGLE", "Angle Register",
      m_admtController->getSensorRegister(
          ADMTController::SensorRegister::ANGLEREG),
      m_admtController->getSensorPage(ADMTController::SensorRegister::ANGLEREG),
      RegisterBlockWidget::ACCESS_PERMISSION::READ, registerWidget);
  angleSecRegisterBlock = new RegisterBlockWidget(
      "ANGLESEC", "Secondary Angle",
      m_admtController->getSensorRegister(
          ADMTController::SensorRegister::ANGLESEC),
      m_admtController->getSensorPage(ADMTController::SensorRegister::ANGLESEC),
      RegisterBlockWidget::ACCESS_PERMISSION::READ, registerWidget);
  sineRegisterBlock = new RegisterBlockWidget(
      "SINE", "Sine Measurement",
      ...
      RegisterBlockWidget::ACCESS_PERMISSION::READ, registerWidget);
  cosineRegisterBlock = new RegisterBlockWidget(
      "COSINE", "Cosine Measurement",
      m_admtController->getSensorRegister(
          ADMTController::SensorRegister::COSINE),
      m_admtController->getSensorPage(ADMTController::SensorRegister::COSINE),
      RegisterBlockWidget::ACCESS_PERMISSION::READ, registerWidget);
  secAnglIRegisterBlock = new RegisterBlockWidget(
      "SECANGLI", "In-phase secondary angle measurement",
      m_admtController->getSensorRegister(
          ADMTController::SensorRegister::SECANGLI),
      m_admtController->getSensorPage(ADMTController::SensorRegister::SECANGLI),
      RegisterBlockWidget::ACCESS_PERMISSION::READ, registerWidget);
  secAnglQRegisterBlock = new RegisterBlockWidget(
      "SECANGLQ", "Quadrature phase secondary angle measurement",
      m_admtController->getSensorRegister(
          ADMTController::SensorRegister::SECANGLQ),
      m_admtController->getSensorPage(ADMTController::SensorRegister::SECANGLQ),
      RegisterBlockWidget::ACCESS_PERMISSION::READ, registerWidget);
  radiusRegisterBlock = new RegisterBlockWidget(
      "RADIUS", "Angle measurement radius",
      m_admtController->getSensorRegister(
          ADMTController::SensorRegister::RADIUS),
      m_admtController->getSensorPage(ADMTController::SensorRegister::RADIUS),
      RegisterBlockWidget::ACCESS_PERMISSION::READ, registerWidget);
  diag1RegisterBlock = new RegisterBlockWidget(
      "DIAG1",
      "State of the MT reference resistors and AFE fixed input voltage",
      m_admtController->getSensorRegister(
          ADMTController::SensorRegister::DIAG1),
      m_admtController->getSensorPage(ADMTController::SensorRegister::DIAG1),
      RegisterBlockWidget::ACCESS_PERMISSION::READ, registerWidget);
  diag2RegisterBlock = new RegisterBlockWidget(
      "DIAG2", "Measurements of two diagnostics resistors of fixed value",
      m_admtController->getSensorRegister(
          ADMTController::SensorRegister::DIAG2),
      m_admtController->getSensorPage(ADMTController::SensorRegister::DIAG2),
      RegisterBlockWidget::ACCESS_PERMISSION::READ, registerWidget);
  tmp0RegisterBlock = new RegisterBlockWidget(
      "TMP0", "Primary Temperature Sensor",
      ...
      RegisterBlockWidget::ACCESS_PERMISSION::READ, registerWidget);
  tmp1RegisterBlock = new RegisterBlockWidget(
      "TMP1", "Secondary Temperature Sensor",
      ...
      RegisterBlockWidget::ACCESS_PERMISSION::READ, registerWidget);
  cnvCntRegisterBlock = new RegisterBlockWidget(
      "CNVCNT", "Conversion Count",
      m_admtController->getSensorRegister(
          ADMTController::SensorRegister::CNVCNT),
  ...
  uniqID0RegisterBlock = new RegisterBlockWidget(
      ...
      m_admtController->getUniqueIdRegister(
          ADMTController::UniqueIDRegister::UNIQID0),
      m_admtController->getUniqueIdPage(
          ADMTController::UniqueIDRegister::UNIQID0),
      RegisterBlockWidget::ACCESS_PERMISSION::READ, registerWidget);
  uniqID1RegisterBlock = new RegisterBlockWidget(
      "UNIQID1", "Unique ID Register 1",
      m_admtController->getUniqueIdRegister(
          ADMTController::UniqueIDRegister::UNIQID1),
      m_admtController->getUniqueIdPage(
          ADMTController::UniqueIDRegister::UNIQID1),
      RegisterBlockWidget::ACCESS_PERMISSION::READ, registerWidget);
  uniqID2RegisterBlock = new RegisterBlockWidget(
      ...
      m_admtController->getUniqueIdRegister(
          ADMTController::UniqueIDRegister::UNIQID2),
      m_admtController->getUniqueIdPage(
          ADMTController::UniqueIDRegister::UNIQID2),
      RegisterBlockWidget::ACCESS_PERMISSION::READ, registerWidget);
  ...
  h1MagRegisterBlock = new RegisterBlockWidget(
      "H1MAG", "1st Harmonic error magnitude",
      m_admtController->getHarmonicRegister(
          ADMTController::HarmonicRegister::H1MAG),
      m_admtController->getHarmonicPage(
          ADMTController::HarmonicRegister::H1MAG),
      RegisterBlockWidget::ACCESS_PERMISSION::READWRITE, registerWidget);
  h1PhRegisterBlock = new RegisterBlockWidget(
      "H1PH", "1st Harmonic error phase",
      m_admtController->getHarmonicRegister(
          ADMTController::HarmonicRegister::H1PH),
      m_admtController->getHarmonicPage(ADMTController::HarmonicRegister::H1PH),
      RegisterBlockWidget::ACCESS_PERMISSION::READWRITE, registerWidget);
  h2MagRegisterBlock = new RegisterBlockWidget(
      "H2MAG", "2nd Harmonic error magnitude",
      m_admtController->getHarmonicRegister(
          ADMTController::HarmonicRegister::H2MAG),
      m_admtController->getHarmonicPage(
          ADMTController::HarmonicRegister::H2MAG),
      RegisterBlockWidget::ACCESS_PERMISSION::READWRITE, registerWidget);
  h2PhRegisterBlock = new RegisterBlockWidget(
      "H2PH", "2nd Harmonic error phase",
      m_admtController->getHarmonicRegister(
          ADMTController::HarmonicRegister::H2PH),
      m_admtController->getHarmonicPage(ADMTController::HarmonicRegister::H2PH),
      RegisterBlockWidget::ACCESS_PERMISSION::READWRITE, registerWidget);
  h3MagRegisterBlock = new RegisterBlockWidget(
      "H3MAG", "3rd Harmonic error magnitude",
      m_admtController->getHarmonicRegister(
          ADMTController::HarmonicRegister::H3MAG),
      m_admtController->getHarmonicPage(
          ADMTController::HarmonicRegister::H3MAG),
      RegisterBlockWidget::ACCESS_PERMISSION::READWRITE, registerWidget);
  h3PhRegisterBlock = new RegisterBlockWidget(
      "H3PH", "3rd Harmonic error phase",
      m_admtController->getHarmonicRegister(
          ADMTController::HarmonicRegister::H3PH),
      m_admtController->getHarmonicPage(ADMTController::HarmonicRegister::H3PH),
      RegisterBlockWidget::ACCESS_PERMISSION::READWRITE, registerWidget);
  h8MagRegisterBlock = new RegisterBlockWidget(
      "H8MAG", "8th Harmonic error magnitude",
      m_admtController->getHarmonicRegister(
          ADMTController::HarmonicRegister::H8MAG),
      m_admtController->getHarmonicPage(
          ADMTController::HarmonicRegister::H8MAG),
      RegisterBlockWidget::ACCESS_PERMISSION::READWRITE, registerWidget);
  h8PhRegisterBlock = new RegisterBlockWidget(
      "H8PH", "8th Harmonic error phase",
      m_admtController->getHarmonicRegister(
          ADMTController::HarmonicRegister::H8PH),
  ...
  QSpacerItem *registerDeviceSpacer =
  ...
  readAllRegistersButton =
      new QPushButton("Read All Registers", registerWidget);
  StyleHelper::BasicButton(readAllRegistersButton);
  readAllRegistersButton->setFixedWidth(270);
  connect(readAllRegistersButton, &QPushButton::clicked, this,
          &HarmonicCalibration::readAllRegisters);
  ...
  tool->addWidgetToTopContainerHelper(registerActionsWidget,
                                      ToolTemplateAlignment::TTA_LEFT);
  tool->addWidgetToCentralContainerHelper(registerScrollArea);

  tool->layout()->setMargin(0);
  tool->layout()->setContentsMargins(
...
#pragma region Command Log Widget
  MenuSectionWidget *commandLogSectionWidget =
      new MenuSectionWidget(leftUtilityWidget);
  Style::setStyle(commandLogSectionWidget,
                  style::properties::widget::basicComponent);
  MenuCollapseSection *commandLogCollapseSection = new MenuCollapseSection(
      "Command Log", MenuCollapseSection::MHCW_NONE,
      MenuCollapseSection::MenuHeaderWidgetType::MHW_BASEWIDGET,
      commandLogSectionWidget);
  commandLogSectionWidget->setSizePolicy(QSizePolicy::MinimumExpanding,
                                         QSizePolicy::MinimumExpanding);
  commandLogSectionWidget->contentLayout()->addWidget(
      commandLogCollapseSection);
  ...
  commandLogPlainTextEdit->setSizePolicy(QSizePolicy::MinimumExpanding,
                                         QSizePolicy::MinimumExpanding);
  commandLogPlainTextEdit->setStyleSheet("QPlainTextEdit { border: none; }");

  clearCommandLogButton =
      new QPushButton("Clear Command Logs", commandLogSectionWidget);
  StyleHelper::BasicButton(clearCommandLogButton);
  connect(clearCommandLogButton, &QPushButton::clicked, this,
          &HarmonicCalibration::clearCommandLog);

  commandLogCollapseSection->contentLayout()->addWidget(
      commandLogPlainTextEdit);
...
#pragma region Center Utility Widget
  ...
  centerUtilityWidget->setSizePolicy(QSizePolicy::MinimumExpanding,
                                     QSizePolicy::MinimumExpanding);
...
#pragma region DIGIO Monitor
  MenuSectionWidget *DIGIOMonitorSectionWidget =
      new MenuSectionWidget(DIGIOWidget);
  Style::setStyle(DIGIOMonitorSectionWidget,
                  style::properties::widget::basicComponent);
  MenuCollapseSection *DIGIOMonitorCollapseSection = new MenuCollapseSection(
      ...
      MenuCollapseSection::MenuHeaderWidgetType::MHW_BASEWIDGET,
      DIGIOMonitorSectionWidget);
  DIGIOMonitorSectionWidget->contentLayout()->addWidget(
      DIGIOMonitorCollapseSection);
  DIGIOMonitorCollapseSection->contentLayout()->setSpacing(8);

  DIGIOBusyStatusLED = createStatusLEDWidget("BUSY (Output)", "digio", false,
                                             DIGIOMonitorCollapseSection);
  DIGIOCNVStatusLED = createStatusLEDWidget("CNV (Input)", "digio", false,
                                            DIGIOMonitorCollapseSection);
  DIGIOSENTStatusLED = createStatusLEDWidget("SENT (Output)", "digio", false,
                                             DIGIOMonitorCollapseSection);
  DIGIOACALCStatusLED = createStatusLEDWidget("ACALC (Output)", "digio", false,
                                              DIGIOMonitorCollapseSection);
  DIGIOFaultStatusLED = createStatusLEDWidget("FAULT (Output)", "digio", false,
                                              DIGIOMonitorCollapseSection);
  DIGIOBootloaderStatusLED = createStatusLEDWidget(
      "BOOTLOADER (Output)", "digio", false, DIGIOMonitorCollapseSection);
  ...
  DIGIOMonitorCollapseSection->contentLayout()->addWidget(
      DIGIOBootloaderStatusLED);
#pragma endregion

#pragma region DIGIO Control
  MenuSectionWidget *DIGIOControlSectionWidget =
      new MenuSectionWidget(DIGIOWidget);
  Style::setStyle(DIGIOControlSectionWidget,
                  style::properties::widget::basicComponent);
  ...
  DIGIOControlSectionWidget->contentLayout()->addWidget(
  ...
  QLabel *DIGIOFunctionLabel =
      new QLabel("DIGIO Function", DIGIOControlGridWidget);
  ...
  connect(DIGIO0ENToggleSwitch, &CustomSwitch::clicked,
          [this](bool value) { toggleDIGIOEN("DIGIO0EN", value); });

  DIGIO0FNCToggleSwitch = new CustomSwitch();
  changeCustomSwitchLabel(DIGIO0FNCToggleSwitch, "GPIO0", "BUSY");
  connect(DIGIO0FNCToggleSwitch, &CustomSwitch::clicked,
          [this](bool value) { toggleDIGIOEN("BUSY", value); });

  DIGIO1ENToggleSwitch = new CustomSwitch();
  changeCustomSwitchLabel(DIGIO1ENToggleSwitch, "Output", "Input");
  connect(DIGIO1ENToggleSwitch, &CustomSwitch::clicked,
          [this](bool value) { toggleDIGIOEN("DIGIO1EN", value); });

  DIGIO1FNCToggleSwitch = new CustomSwitch();
  changeCustomSwitchLabel(DIGIO1FNCToggleSwitch, "GPIO1", "CNV");
  connect(DIGIO1FNCToggleSwitch, &CustomSwitch::clicked,
          [this](bool value) { toggleDIGIOEN("CNV", value); });

  DIGIO2ENToggleSwitch = new CustomSwitch();
  changeCustomSwitchLabel(DIGIO2ENToggleSwitch, "Output", "Input");
  connect(DIGIO2ENToggleSwitch, &CustomSwitch::clicked,
          [this](bool value) { toggleDIGIOEN("DIGIO2EN", value); });

  DIGIO2FNCToggleSwitch = new CustomSwitch();
  changeCustomSwitchLabel(DIGIO2FNCToggleSwitch, "GPIO2", "SENT");
  connect(DIGIO2FNCToggleSwitch, &CustomSwitch::clicked,
          [this](bool value) { toggleDIGIOEN("SENT", value); });

  DIGIO3ENToggleSwitch = new CustomSwitch();
  changeCustomSwitchLabel(DIGIO3ENToggleSwitch, "Output", "Input");
  connect(DIGIO3ENToggleSwitch, &CustomSwitch::clicked,
          [this](bool value) { toggleDIGIOEN("DIGIO3EN", value); });

  DIGIO3FNCToggleSwitch = new CustomSwitch();
  changeCustomSwitchLabel(DIGIO3FNCToggleSwitch, "GPIO3", "ACALC");
  connect(DIGIO3FNCToggleSwitch, &CustomSwitch::clicked,
          [this](bool value) { toggleDIGIOEN("ACALC", value); });

  DIGIO4ENToggleSwitch = new CustomSwitch();
  changeCustomSwitchLabel(DIGIO4ENToggleSwitch, "Output", "Input");
  connect(DIGIO4ENToggleSwitch, &CustomSwitch::clicked,
          [this](bool value) { toggleDIGIOEN("DIGIO4EN", value); });

  DIGIO4FNCToggleSwitch = new CustomSwitch();
  changeCustomSwitchLabel(DIGIO4FNCToggleSwitch, "GPIO4", "FAULT");
  connect(DIGIO4FNCToggleSwitch, &CustomSwitch::clicked,
          [this](bool value) { toggleDIGIOEN("FAULT", value); });

  DIGIO5ENToggleSwitch = new CustomSwitch();
  changeCustomSwitchLabel(DIGIO5ENToggleSwitch, "Output", "Input");
  connect(DIGIO5ENToggleSwitch, &CustomSwitch::clicked,
          [this](bool value) { toggleDIGIOEN("DIGIO5EN", value); });
  ...
  QPushButton *DIGIOResetButton =
      new QPushButton("Reset DIGIO", DIGIOControlGridWidget);
  ...
  DIGIOControlCollapseSection->contentLayout()->addWidget(
      DIGIOControlGridWidget);
...
#pragma region MTDIAG1 Widget
  MenuSectionWidget *MTDIAG1SectionWidget =
      new MenuSectionWidget(centerUtilityWidget);
  Style::setStyle(MTDIAG1SectionWidget,
                  style::properties::widget::basicComponent);
  MenuCollapseSection *MTDIAG1CollapseSection = new MenuCollapseSection(
      "MT Diagnostic Register",
      MenuCollapseSection::MenuHeaderCollapseStyle::MHCW_NONE,
      MenuCollapseSection::MenuHeaderWidgetType::MHW_BASEWIDGET,
      MTDIAG1SectionWidget);
  MTDIAG1SectionWidget->contentLayout()->addWidget(MTDIAG1CollapseSection);
  MTDIAG1CollapseSection->contentLayout()->setSpacing(8);

  R0StatusLED =
      createStatusLEDWidget("R0", "mtdiag", false, MTDIAG1SectionWidget);
  R1StatusLED =
      createStatusLEDWidget("R1", "mtdiag", false, MTDIAG1SectionWidget);
  R2StatusLED =
      createStatusLEDWidget("R2", "mtdiag", false, MTDIAG1SectionWidget);
  R3StatusLED =
      createStatusLEDWidget("R3", "mtdiag", false, MTDIAG1SectionWidget);
  R4StatusLED =
      createStatusLEDWidget("R4", "mtdiag", false, MTDIAG1SectionWidget);
  R5StatusLED =
      createStatusLEDWidget("R5", "mtdiag", false, MTDIAG1SectionWidget);
  R6StatusLED =
      createStatusLEDWidget("R6", "mtdiag", false, MTDIAG1SectionWidget);
  R7StatusLED =
      createStatusLEDWidget("R7", "mtdiag", false, MTDIAG1SectionWidget);
...
#pragma region MT Diagnostics
  ...
  MenuSectionWidget *MTDiagnosticsSectionWidget =
      new MenuSectionWidget(centerUtilityWidget);
  Style::setStyle(MTDiagnosticsSectionWidget,
                  style::properties::widget::basicComponent);
  MenuCollapseSection *MTDiagnosticsCollapseSection = new MenuCollapseSection(
      ...
      MenuCollapseSection::MenuHeaderWidgetType::MHW_BASEWIDGET,
      MTDiagnosticsSectionWidget);
  MTDiagnosticsSectionWidget->contentLayout()->addWidget(
...
#pragma region Right Utility Widget
  ...
  MenuSectionWidget *faultRegisterSectionWidget =
      new MenuSectionWidget(rightUtilityWidget);
  Style::setStyle(faultRegisterSectionWidget,
                  style::properties::widget::basicComponent);
  MenuCollapseSection *faultRegisterCollapseSection = new MenuCollapseSection(
      ...
      MenuCollapseSection::MenuHeaderWidgetType::MHW_BASEWIDGET,
      faultRegisterSectionWidget);
  faultRegisterSectionWidget->contentLayout()->addWidget(
      faultRegisterCollapseSection);
  faultRegisterCollapseSection->contentLayout()->setSpacing(8);

  VDDUnderVoltageStatusLED = createStatusLEDWidget(
      "VDD Under Voltage", "fault", false, faultRegisterCollapseSection);
  VDDOverVoltageStatusLED = createStatusLEDWidget(
      "VDD Over Voltage", "fault", false, faultRegisterCollapseSection);
  VDRIVEUnderVoltageStatusLED = createStatusLEDWidget(
      "VDRIVE Under Voltage", "fault", false, faultRegisterCollapseSection);
  VDRIVEOverVoltageStatusLED = createStatusLEDWidget(
      "VDRIVE Over Voltage", "fault", false, faultRegisterCollapseSection);
  AFEDIAGStatusLED = createStatusLEDWidget("AFEDIAG", "fault", false,
                                           faultRegisterCollapseSection);
  NVMCRCFaultStatusLED = createStatusLEDWidget("NVM CRC Fault", "fault", false,
                                               faultRegisterCollapseSection);
  ECCDoubleBitErrorStatusLED = createStatusLEDWidget(
      "ECC Double Bit Error", "fault", false, faultRegisterCollapseSection);
  OscillatorDriftStatusLED = createStatusLEDWidget(
      "Oscillator Drift", "fault", false, faultRegisterCollapseSection);
  CountSensorFalseStateStatusLED = createStatusLEDWidget(
      "Count Sensor False State", "fault", false, faultRegisterCollapseSection);
  AngleCrossCheckStatusLED = createStatusLEDWidget(
      "Angle Cross Check", "fault", false, faultRegisterCollapseSection);
  TurnCountSensorLevelsStatusLED = createStatusLEDWidget(
      "Turn Count Sensor Levels", "fault", false, faultRegisterCollapseSection);
  MTDIAGStatusLED = createStatusLEDWidget("MTDIAG", "fault", false,
                                          faultRegisterCollapseSection);
  TurnCounterCrossCheckStatusLED = createStatusLEDWidget(
      "Turn Counter Cross Check", "fault", false, faultRegisterCollapseSection);
  RadiusCheckStatusLED = createStatusLEDWidget("Radius Check", "fault", false,
                                               faultRegisterCollapseSection);
  SequencerWatchdogStatusLED = createStatusLEDWidget(
      "Sequencer Watchdog", "fault", false, faultRegisterCollapseSection);

  faultRegisterCollapseSection->contentLayout()->addWidget(
  ...
  rightUtilityLayout->addSpacerItem(
      new QSpacerItem(0, 0, QSizePolicy::Minimum, QSizePolicy::Expanding));
#pragma endregion
...
void HarmonicCalibration::readDeviceProperties() {
  ...
  uint32_t page = m_admtController->getUniqueIdPage(
      ADMTController::UniqueIDRegister::UNIQID3);
  uint32_t cnvPageAddress = m_admtController->getConfigurationRegister(
      ADMTController::ConfigurationRegister::CNVPAGE);
    ...
    if (m_admtController->readDeviceRegistry(
      ...
      if (*cnvPageRegValue == page) {
        if (m_admtController->readDeviceRegistry(
          ...
          deviceName =
              QString::fromStdString(deviceRegisterMap.at("Product ID"));
          ...
          if (deviceRegisterMap.at("ASIL ID") == "ASIL QM") {
            ...
            deviceType =
                QString::fromStdString(deviceRegisterMap.at("ASIL ID"));
          }
...
bool HarmonicCalibration::readSequence() {
  ...
  uint32_t generalRegisterAddress = m_admtController->getConfigurationRegister(
      ADMTController::ConfigurationRegister::GENERAL);
  uint32_t generalRegisterPage = m_admtController->getConfigurationPage(
      ADMTController::ConfigurationRegister::GENERAL);
...
bool HarmonicCalibration::writeSequence(const map<string, int> &settings) {
  ...
  if (m_admtController->readDeviceRegistry(
    ...
    uint32_t newGeneralRegValue =
        m_admtController->setGeneralRegisterBitMapping(*generalRegValue,
                                                       settings);
    uint32_t generalRegisterPage = m_admtController->getConfigurationPage(
        ADMTController::ConfigurationRegister::GENERAL);
      ...
      if (m_admtController->writeDeviceRegistry(
        ...
        if (readSequence()) {
          if (settings.at("Convert Synchronization") ==
              ...
              settings.at("Angle Filter") ==
                  GENERALRegisterMap.at("Angle Filter") &&
              settings.at("8th Harmonic") ==
                  GENERALRegisterMap.at("8th Harmonic") &&
              settings.at("Sequence Type") ==
                  GENERALRegisterMap.at("Sequence Type") &&
              settings.at("Conversion Type") ==
                  GENERALRegisterMap.at("Conversion Type")) {
            success = true;
          }
        }
      }
...
void HarmonicCalibration::applySequence() {
  ...
  settings["Sequence Type"] = qvariant_cast<int>(
      sequenceTypeMenuCombo->combo()->currentData()); // sequenceType;
  settings["Conversion Type"] = qvariant_cast<int>(
      conversionTypeMenuCombo->combo()->currentData()); // conversionType;
  settings["Convert Synchronization"] = qvariant_cast<int>(
      convertSynchronizationMenuCombo->combo()->currentData()); // convertSync;
  settings["Angle Filter"] = qvariant_cast<int>(
      angleFilterMenuCombo->combo()->currentData()); // angleFilter;
  settings["8th Harmonic"] = qvariant_cast<int>(
      eighthHarmonicMenuCombo->combo()->currentData()); // eighthHarmonic;
...
void HarmonicCalibration::initializeMotor() {
  ...
  ramp_mode = 0;
  writeMotorAttributeValue(ADMTController::MotorAttribute::RAMP_MODE,
                           ramp_mode);
  readMotorAttributeValue(ADMTController::MotorAttribute::RAMP_MODE, ramp_mode);

  target_pos = 0;
  writeMotorAttributeValue(ADMTController::MotorAttribute::TARGET_POS,
                           target_pos);

  current_pos = 0;
  readMotorAttributeValue(ADMTController::MotorAttribute::CURRENT_POS,
                          current_pos);
}
...
void HarmonicCalibration::startDeviceStatusMonitor() {
  if (!m_deviceStatusThread.isRunning()) {
    ...
    m_deviceStatusThread =
        QtConcurrent::run(this, &HarmonicCalibration::getDeviceFaultStatus,
                          deviceStatusMonitorRate);
...
void HarmonicCalibration::startCurrentMotorPositionMonitor() {
  if (!m_currentMotorPositionThread.isRunning()) {
    ...
    m_currentMotorPositionThread =
        QtConcurrent::run(this, &HarmonicCalibration::currentMotorPositionTask,
  ...
  if (m_admtController->writeDeviceRegistry(
    ...
    if (m_admtController->readDeviceRegistry(
            ...
            m_admtController->getSensorRegister(
                ADMTController::SensorRegister::ABSANGLE),
            absAngleRegValue) == 0) {
      count = m_admtController->getAbsAngleTurnCount(
          static_cast<uint16_t>(*absAngleRegValue));
      success = true;
    }
  }
  if (!success) {
...
void HarmonicCalibration::startAcquisition() {
  ...
  m_acquisitionDataThread = QtConcurrent::run(
      this, &HarmonicCalibration::getAcquisitionSamples, acquisitionSampleRate);
  m_acquisitionDataWatcher.setFuture(m_acquisitionDataThread);
  m_acquisitionGraphThread =
      QtConcurrent::run(this, &HarmonicCalibration::acquisitionPlotTask,
                        acquisitionGraphSampleRate);
...
void HarmonicCalibration::getAcquisitionSamples(int sampleRate) {
  while (isStartAcquisition) {
    ...
    if (acquisitionDataMap.at(ANGLE) == false &&
        acquisitionAngleList.size() > 0)
      acquisitionAngleList.clear();
    if (acquisitionDataMap.at(ABSANGLE) == false &&
        acquisitionABSAngleList.size() > 0)
      acquisitionABSAngleList.clear();
    if (acquisitionDataMap.at(TURNCOUNT) == false &&
        acquisitionTurnCountList.size() > 0)
    ...
    if (acquisitionDataMap.at(COSINE) == false &&
        acquisitionCosineList.size() > 0)
      acquisitionCosineList.clear();
    if (acquisitionDataMap.at(RADIUS) == false &&
        acquisitionRadiusList.size() > 0)
    ...
    if (acquisitionDataMap.at(SINE))
      prependAcquisitionData(getAcquisitionParameterValue(SINE),
                             acquisitionSineList);
    if (acquisitionDataMap.at(COSINE))
      prependAcquisitionData(getAcquisitionParameterValue(COSINE),
                             acquisitionCosineList);
    if (acquisitionDataMap.at(RADIUS))
      prependAcquisitionData(getAcquisitionParameterValue(RADIUS),
...
double HarmonicCalibration::getAcquisitionParameterValue(
    const AcquisitionDataKey &key) {
  uint32_t *readValue = new uint32_t;
  switch (key) {
  case SINE: {
    if (m_admtController->readDeviceRegistry(
            m_admtController->getDeviceId(ADMTController::Device::ADMT4000),
            m_admtController->getSensorRegister(
                ADMTController::SensorRegister::SINE),
            readValue) == -1)
      return qQNaN();
    map<string, double> sineRegisterMap =
        m_admtController->getSineRegisterBitMapping(
            static_cast<uint16_t>(*readValue));
  ...
  case COSINE: {
    ...
    map<string, double> cosineRegisterMap =
        m_admtController->getCosineRegisterBitMapping(
            static_cast<uint16_t>(*readValue));
  ...
  case RADIUS: {
    ...
    map<string, double> radiusRegisterMap =
        m_admtController->getRadiusRegisterBitMapping(
            static_cast<uint16_t>(*readValue));
...
void HarmonicCalibration::plotAcquisition(QVector<double> &list,
                                          PlotChannel *channel) {
...
void HarmonicCalibration::prependAcquisitionData(const double &data,
                                                 QVector<double> &list) {
  list.prepend(data);
...
void HarmonicCalibration::acquisitionPlotTask(int sampleRate) {
  while (isStartAcquisition) {
    ...
    if (acquisitionDataMap.at(TURNCOUNT))
      plotAcquisition(acquisitionTurnCountList,
    ...
    acquisitionYPlotAxis->setInterval(acquisitionGraphYMin,
                                      acquisitionGraphYMax);
    acquisitionGraphPlotWidget->replot();
...
void HarmonicCalibration::startAcquisitionUITask() {
  if (!m_acquisitionUIThread.isRunning()) {
    ...
    m_acquisitionUIThread = QtConcurrent::run(
        this, &HarmonicCalibration::acquisitionUITask, acquisitionUITimerRate);
...
void HarmonicCalibration::updateSequenceWidget() {
  if (GENERALRegisterMap.at("Sequence Type") == -1) {
    ...
    sequenceTypeMenuCombo->combo()->setCurrentIndex(
        sequenceTypeMenuCombo->combo()->findData(
            GENERALRegisterMap.at("Sequence Type")));
  }
  conversionTypeMenuCombo->combo()->setCurrentIndex(
      conversionTypeMenuCombo->combo()->findData(
          GENERALRegisterMap.at("Conversion Type")));
  ...
  angleFilterMenuCombo->combo()->setCurrentIndex(
      angleFilterMenuCombo->combo()->findData(
          GENERALRegisterMap.at("Angle Filter")));
  eighthHarmonicMenuCombo->combo()->setCurrentIndex(
      eighthHarmonicMenuCombo->combo()->findData(
          GENERALRegisterMap.at("8th Harmonic")));
}
...
void HarmonicCalibration::connectCheckBoxToAcquisitionGraph(
    QCheckBox *widget, PlotChannel *channel, AcquisitionDataKey key) {
...
void HarmonicCalibration::GMRReset() {
  ...
  m_admtController->setDeviceAttributeValue(
      m_admtController->getDeviceId(ADMTController::Device::ADMT4000),
      m_admtController->getDeviceAttribute(
          ADMTController::DeviceAttribute::SDP_COIL_RS),
      1);
...
void HarmonicCalibration::startCalibrationUITask() {
  if (!m_calibrationUIThread.isRunning()) {
    ...
    m_calibrationUIThread = QtConcurrent::run(
        this, &HarmonicCalibration::calibrationUITask, calibrationUITimerRate);
...
void HarmonicCalibration::startContinuousCalibration() {
  ...
  if (isPostCalibration)
    StatusBarManager::pushMessage(
        "Acquiring Post Calibration Samples, Please Wait...");
  else
    StatusBarManager::pushMessage(
        "Acquiring Calibration Samples, Please Wait...");
...
void HarmonicCalibration::startResetMotorToZero() {
  ...
  if (!m_resetMotorToZeroThread.isRunning()) {
    m_resetMotorToZeroThread =
        QtConcurrent::run(this, &HarmonicCalibration::resetMotorToZero);
...
void HarmonicCalibration::resetMotorToZero() {
  if (readMotorAttributeValue(ADMTController::MotorAttribute::CURRENT_POS,
                              current_pos) == 0) {
    if (current_pos != 0) {
      writeMotorAttributeValue(
          ADMTController::MotorAttribute::ROTATE_VMAX,
...
void HarmonicCalibration::startCalibrationStreamThread() {
  if (!m_calibrationStreamThread.isRunning()) {
    ...
    continuousCalibrationSampleRate = calculateContinuousCalibrationSampleRate(
        convertVMAXtoRPS(rotate_vmax), samplesPerCycle);
    m_calibrationStreamThread = QtConcurrent::run([this]() {
      m_admtController->bufferedStreamIO(totalSamplesCount,
...
void HarmonicCalibration::startWaitForVelocityReachedThread(int mode) {
  if (!m_calibrationWaitVelocityWatcher.isRunning()) {
    ...
    m_calibrationWaitVelocityThread =
        QtConcurrent::run(this, &HarmonicCalibration::waitForVelocityReached,
    ...
    while (isMotorVelocityCheck && !isMotorVelocityReached) {
      if (readMotorRegisterValue(
              m_admtController->getRampGeneratorDriverFeatureControlRegister(
                  ADMTController::RampGeneratorDriverFeatureControlRegister::
                      RAMP_STAT),
              registerValue) == 0) {
...
int HarmonicCalibration::calculateContinuousCalibrationSampleRate(
    double motorRPS, int samplesPerCycle) {
  return static_cast<int>(floor(1 / motorRPS / samplesPerCycle * 1000 * 1000 *
                                1000)); // In nanoseconds
}
...
void HarmonicCalibration::startOneShotCalibration() {
  ...
  QFuture<void> future =
      QtConcurrent::run(this, &HarmonicCalibration::getCalibrationSamples);
  ...
  connect(watcher, &QFutureWatcher<void>::finished, this, [this]() {
    ...
    if (isPostCalibration) {
      if (static_cast<int>(graphPostDataList.size()) == totalSamplesCount) {
        computeSineCosineOfAngles(graphPostDataList);
        m_admtController->postcalibrate(
            vector<double>(graphPostDataList.begin(), graphPostDataList.end()),
            cycleCount, samplesPerCycle, !isMotorRotationClockwise);
        populateCorrectedAngleErrorGraphs();
        isPostCalibration = false;
        isStartMotor = false;
...
void HarmonicCalibration::computeSineCosineOfAngles(
    QVector<double> graphDataList) {
  m_admtController->computeSineCosineOfAngles(
      vector<double>(graphDataList.begin(), graphDataList.end()));
  if (isPostCalibration) {
...
void HarmonicCalibration::populateAngleErrorGraphs() {
  QVector<double> angleError = QVector<double>(
      m_admtController->angleError.begin(), m_admtController->angleError.end());
  ...
  QVector<double> FFTAngleErrorPhase =
      QVector<double>(m_admtController->FFTAngleErrorPhase.begin(),
  ...
  angleErrorYPlotAxis->setInterval(*angleErrorMinMax.first,
                                   *angleErrorMinMax.second);
  ...
  auto angleErrorMagnitudeMinMax = minmax_element(
      FFTAngleErrorMagnitude.begin(), FFTAngleErrorMagnitude.end());
  auto angleErrorPhaseMinMax =
      minmax_element(FFTAngleErrorPhase.begin(), FFTAngleErrorPhase.end());
  double FFTAngleErrorPlotMin =
      *angleErrorMagnitudeMinMax.first < *angleErrorPhaseMinMax.first
          ? *angleErrorMagnitudeMinMax.first
          : *angleErrorPhaseMinMax.first;
  double FFTAngleErrorPlotMax =
      *angleErrorMagnitudeMinMax.second > *angleErrorPhaseMinMax.second
          ? *angleErrorMagnitudeMinMax.second
          : *angleErrorPhaseMinMax.second;
  FFTAngleErrorYPlotAxis->setInterval(FFTAngleErrorPlotMin,
                                      FFTAngleErrorPlotMax);
...
void HarmonicCalibration::populateCorrectedAngleErrorGraphs() {
  ...
  QVector<double> FFTCorrectedErrorMagnitude(
      m_admtController->FFTCorrectedErrorMagnitude.begin(),
      m_admtController->FFTCorrectedErrorMagnitude.end());
  QVector<double> FFTCorrectedErrorPhase(
      m_admtController->FFTCorrectedErrorPhase.begin(),
      m_admtController->FFTCorrectedErrorPhase.end());

  correctedErrorPlotChannel->curve()->setSamples(correctedError);
  auto correctedErrorMagnitudeMinMax =
  ...
  FFTCorrectedErrorMagnitudeChannel->curve()->setSamples(
      FFTCorrectedErrorMagnitude);
  auto FFTCorrectedErrorMagnitudeMinMax = minmax_element(
      FFTCorrectedErrorMagnitude.begin(), FFTCorrectedErrorMagnitude.end());
  auto FFTCorrectedErrorPhaseMinMax = minmax_element(
      FFTCorrectedErrorPhase.begin(), FFTCorrectedErrorPhase.end());
  double FFTCorrectedErrorPlotMin =
...
void HarmonicCalibration::clearHarmonicRegisters() {
  bool success = false;
  uint32_t value = 0x0;
  uint32_t harmonicCNVPage = m_admtController->getHarmonicPage(
      ADMTController::HarmonicRegister::H1MAG);
...
void HarmonicCalibration::flashHarmonicValues() {
  if (changeCNVPage(0x02)) {
    m_admtController->writeDeviceRegistry(
        m_admtController->getDeviceId(ADMTController::Device::ADMT4000), 0x01,
        0x02);
...
void HarmonicCalibration::calculateHarmonicValues() {
  uint32_t *h1MagCurrent = new uint32_t, *h1PhaseCurrent = new uint32_t,
           *h2MagCurrent = new uint32_t, *h2PhaseCurrent = new uint32_t,
           *h3MagCurrent = new uint32_t, *h3PhaseCurrent = new uint32_t,
  ...
  if (changeCNVPage(0x02)) {
    ...
    H1_MAG_HEX = static_cast<uint32_t>(
        m_admtController->calculateHarmonicCoefficientMagnitude(
            static_cast<uint16_t>(m_admtController->HAR_MAG_1),
            static_cast<uint16_t>(*h1MagCurrent), "h1"));
    H2_MAG_HEX = static_cast<uint32_t>(
        m_admtController->calculateHarmonicCoefficientMagnitude(
            static_cast<uint16_t>(m_admtController->HAR_MAG_2),
            static_cast<uint16_t>(*h2MagCurrent), "h2"));
    H3_MAG_HEX = static_cast<uint32_t>(
        m_admtController->calculateHarmonicCoefficientMagnitude(
            static_cast<uint16_t>(m_admtController->HAR_MAG_3),
            static_cast<uint16_t>(*h3MagCurrent), "h3"));
    H8_MAG_HEX = static_cast<uint32_t>(
        m_admtController->calculateHarmonicCoefficientMagnitude(
            static_cast<uint16_t>(m_admtController->HAR_MAG_8),
            static_cast<uint16_t>(*h8MagCurrent), "h8"));
    H1_PHASE_HEX = static_cast<uint32_t>(
        m_admtController->calculateHarmonicCoefficientPhase(
            static_cast<uint16_t>(m_admtController->HAR_PHASE_1),
            static_cast<uint16_t>(*h1PhaseCurrent)));
    H2_PHASE_HEX = static_cast<uint32_t>(
        m_admtController->calculateHarmonicCoefficientPhase(
            static_cast<uint16_t>(m_admtController->HAR_PHASE_2),
            static_cast<uint16_t>(*h2PhaseCurrent)));
    H3_PHASE_HEX = static_cast<uint32_t>(
        m_admtController->calculateHarmonicCoefficientPhase(
            static_cast<uint16_t>(m_admtController->HAR_PHASE_3),
            static_cast<uint16_t>(*h3PhaseCurrent)));
    H8_PHASE_HEX = static_cast<uint32_t>(
        m_admtController->calculateHarmonicCoefficientPhase(
            static_cast<uint16_t>(m_admtController->HAR_PHASE_8),
            static_cast<uint16_t>(*h8PhaseCurrent)));

    calibrationLogWrite();
    calibrationLogWrite(
        QString("Calculated H1 Mag (Hex): 0x%1")
            .arg(QString::number(H1_MAG_HEX, 16).rightJustified(4, '0')));
    calibrationLogWrite(
        QString("Calculated H1 Phase (Hex): 0x%1")
            .arg(QString::number(H1_PHASE_HEX, 16).rightJustified(4, '0')));
    calibrationLogWrite(
        QString("Calculated H2 Mag (Hex): 0x%1")
            .arg(QString::number(H2_MAG_HEX, 16).rightJustified(4, '0')));
    calibrationLogWrite(
        QString("Calculated H2 Phase (Hex): 0x%1")
            .arg(QString::number(H2_PHASE_HEX, 16).rightJustified(4, '0')));
    calibrationLogWrite(
        QString("Calculated H3 Mag (Hex): 0x%1")
            .arg(QString::number(H3_MAG_HEX, 16).rightJustified(4, '0')));
    calibrationLogWrite(
        QString("Calculated H3 Phase (Hex): 0x%1")
            .arg(QString::number(H3_PHASE_HEX, 16).rightJustified(4, '0')));
    calibrationLogWrite(
        QString("Calculated H8 Mag (Hex): 0x%1")
            .arg(QString::number(H8_MAG_HEX, 16).rightJustified(4, '0')));
    calibrationLogWrite(
        QString("Calculated H8 Phase (Hex): 0x%1")
            .arg(QString::number(H8_PHASE_HEX, 16).rightJustified(4, '0')));

    // Get actual harmonic values from hex
    H1_MAG_ANGLE = m_admtController->getActualHarmonicRegisterValue(
        static_cast<uint16_t>(H1_MAG_HEX), "h1mag");
    H1_PHASE_ANGLE = m_admtController->getActualHarmonicRegisterValue(
        static_cast<uint16_t>(H1_PHASE_HEX), "h1phase");
    H2_MAG_ANGLE = m_admtController->getActualHarmonicRegisterValue(
        static_cast<uint16_t>(H2_MAG_HEX), "h2mag");
    H2_PHASE_ANGLE = m_admtController->getActualHarmonicRegisterValue(
        static_cast<uint16_t>(H2_PHASE_HEX), "h2phase");
    H3_MAG_ANGLE = m_admtController->getActualHarmonicRegisterValue(
        static_cast<uint16_t>(H3_MAG_HEX), "h3mag");
    H3_PHASE_ANGLE = m_admtController->getActualHarmonicRegisterValue(
        static_cast<uint16_t>(H3_PHASE_HEX), "h3phase");
    H8_MAG_ANGLE = m_admtController->getActualHarmonicRegisterValue(
        static_cast<uint16_t>(H8_MAG_HEX), "h8mag");
    H8_PHASE_ANGLE = m_admtController->getActualHarmonicRegisterValue(
        static_cast<uint16_t>(H8_PHASE_HEX), "h8phase");

    calibrationLogWrite();
    calibrationLogWrite(QString("Calculated H1 Mag (Angle): %1°")
                            .arg(QString::number(H1_MAG_ANGLE)));
    calibrationLogWrite(QString("Calculated H1 Phase (Angle): %1°")
                            .arg(QString::number(H1_PHASE_ANGLE)));
    calibrationLogWrite(QString("Calculated H2 Mag (Angle): %1°")
                            .arg(QString::number(H2_MAG_ANGLE)));
    calibrationLogWrite(QString("Calculated H2 Phase (Angle): %1°")
                            .arg(QString::number(H2_PHASE_ANGLE)));
    calibrationLogWrite(QString("Calculated H3 Mag (Angle): %1°")
                            .arg(QString::number(H3_MAG_ANGLE)));
    calibrationLogWrite(QString("Calculated H3 Phase (Angle): %1°")
                            .arg(QString::number(H3_PHASE_ANGLE)));
    calibrationLogWrite(QString("Calculated H8 Mag (Angle): %1°")
                            .arg(QString::number(H8_MAG_ANGLE)));
    calibrationLogWrite(QString("Calculated H8 Phase (Angle): %1°")
                            .arg(QString::number(H8_PHASE_ANGLE)));
...
void HarmonicCalibration::updateCalculatedCoeffAngle() {
  ...
  calibrationH1PhaseLabel->setText("Φ " +
                                   QString::number(H1_PHASE_ANGLE, 'f', 2));
  calibrationH2PhaseLabel->setText("Φ " +
                                   QString::number(H2_PHASE_ANGLE, 'f', 2));
  calibrationH3PhaseLabel->setText("Φ " +
                                   QString::number(H3_PHASE_ANGLE, 'f', 2));
  calibrationH8PhaseLabel->setText("Φ " +
                                   QString::number(H8_PHASE_ANGLE, 'f', 2));
}

void HarmonicCalibration::updateCalculatedCoeffHex() {
  calibrationH1MagLabel->setText(
      QString("0x%1").arg(H1_MAG_HEX, 4, 16, QChar('0')));
  calibrationH2MagLabel->setText(
      QString("0x%1").arg(H2_MAG_HEX, 4, 16, QChar('0')));
  calibrationH3MagLabel->setText(
      QString("0x%1").arg(H3_MAG_HEX, 4, 16, QChar('0')));
  calibrationH8MagLabel->setText(
      QString("0x%1").arg(H8_MAG_HEX, 4, 16, QChar('0')));
  calibrationH1PhaseLabel->setText(
      QString("0x%1").arg(H1_PHASE_HEX, 4, 16, QChar('0')));
  calibrationH2PhaseLabel->setText(
      QString("0x%1").arg(H2_PHASE_HEX, 4, 16, QChar('0')));
  calibrationH3PhaseLabel->setText(
      QString("0x%1").arg(H3_PHASE_HEX, 4, 16, QChar('0')));
  calibrationH8PhaseLabel->setText(
      QString("0x%1").arg(H8_PHASE_HEX, 4, 16, QChar('0')));
}
...
void HarmonicCalibration::importCalibrationData() {
  QString fileName =
      QFileDialog::getOpenFileName(this, tr("Import"), "",
  ...
  try {
    ...
    if (graphDataList.size() > 0) {
      ...
      calibrationLogWrite(m_admtController->calibrate(
          vector<double>(graphDataList.begin(), graphDataList.end()),
          cycleCount, samplesPerCycle, false)); // TODO: Hard-coded Clockwise
      populateAngleErrorGraphs();
      toggleCalibrationButtonState(2);
    }
...
void HarmonicCalibration::extractCalibrationData() {
  ...
  QString fileName =
      QFileDialog::getSaveFileName(this, tr("Export"), "", filter.join(";;"),
  ...
  if (!fileName.isEmpty()) {
    ...
    QVector<double> preCalibrationAngleErrorsFFTMagnitude(
        m_admtController->angle_errors_fft_pre.begin(),
        m_admtController->angle_errors_fft_pre.end());
    QVector<double> preCalibrationAngleErrorsFFTPhase(
        m_admtController->angle_errors_fft_phase_pre.begin(),
    ...
    fm.save(preCalibrationAngleErrorsFFTMagnitude,
            "Pre-Calibration Angle Errors FFT Magnitude");
    fm.save(preCalibrationAngleErrorsFFTPhase,
            "Pre-Calibration Angle Errors FFT Phase");
...
bool HarmonicCalibration::moveMotorToPosition(double &position, bool validate) {
  bool success = false;
  bool canRead = true;
  if (writeMotorAttributeValue(ADMTController::MotorAttribute::TARGET_POS,
                               position) == 0) {
    if (validate) {
      if (readMotorAttributeValue(ADMTController::MotorAttribute::CURRENT_POS,
                                  current_pos) == 0) {
        while (target_pos != current_pos && canRead) {
          canRead =
              readMotorAttributeValue(
                  ADMTController::MotorAttribute::CURRENT_POS, current_pos) == 0
                  ? true
                  : false;
        }
        if (canRead)
...
int HarmonicCalibration::readMotorAttributeValue(
    ADMTController::MotorAttribute attribute, double &value) {
  int result = -1;
  if (!isDebug) {
...
int HarmonicCalibration::writeMotorAttributeValue(
    ADMTController::MotorAttribute attribute, double value) {
  int result = -1;
  if (!isDebug) {
...
int HarmonicCalibration::readMotorRegisterValue(uint32_t address,
                                                uint32_t *value) {
  int result = -1;
  result = m_admtController->readDeviceRegistry(
      m_admtController->getDeviceId(ADMTController::Device::TMC5240), address,
      value);
  return result;
}
...
void HarmonicCalibration::startUtilityTask() {
  if (!m_utilityThread.isRunning()) {
    isUtilityTab = true;
    m_utilityThread = QtConcurrent::run(this, &HarmonicCalibration::utilityTask,
                                        utilityUITimerRate);
...
void HarmonicCalibration::getDIGIOENRegister() {
  ...
  uint32_t digioEnPage = m_admtController->getConfigurationPage(
      ADMTController::ConfigurationRegister::DIGIOEN);
  if (changeCNVPage(digioEnPage)) {
    uint32_t digioRegisterAddress = m_admtController->getConfigurationRegister(
        ADMTController::ConfigurationRegister::DIGIOEN);
...
void HarmonicCalibration::updateDIGIOUI(uint16_t *registerValue) {
  DIGIOENRegisterMap =
      m_admtController->getDIGIOENRegisterBitMapping(*registerValue);
...
void HarmonicCalibration::getDIAG2Register() {
  ...
  uint32_t *cnvPageRegValue = new uint32_t;
  uint32_t mtDiag2RegisterAddress = m_admtController->getSensorRegister(
      ADMTController::SensorRegister::DIAG2);
  uint32_t mtDiag2PageValue =
      m_admtController->getSensorPage(ADMTController::SensorRegister::DIAG2);
  uint32_t cnvPageAddress = m_admtController->getConfigurationRegister(
      ADMTController::ConfigurationRegister::CNVPAGE);
  ...
  if (m_admtController->writeDeviceRegistry(
    ...
    if (m_admtController->readDeviceRegistry(
      ...
      if (*cnvPageRegValue == mtDiag2PageValue) {
        if (m_admtController->readDeviceRegistry(
          ...
          *mtDiag2RegValue16 = static_cast<uint16_t>(*mtDiag2RegValue);
          ...
          Q_EMIT commandLogWriteSignal(
              "Failed to read MT Diagnostic 2 Register");
        }
      } else {
        Q_EMIT commandLogWriteSignal(
      ...
      Q_EMIT commandLogWriteSignal(
          "Failed to read CNVPAGE for MT Diagnostic 2");
    }
  } else {
...
void HarmonicCalibration::updateMTDiagnosticsUI(uint16_t *registerValue) {
  DIAG2RegisterMap =
      m_admtController->getDiag2RegisterBitMapping(*registerValue);
...
void HarmonicCalibration::getDIAG1Register() {
  ...
  uint32_t *cnvPageRegValue = new uint32_t;
  uint32_t mtDiag1RegisterAddress = m_admtController->getSensorRegister(
      ADMTController::SensorRegister::DIAG1);
  uint32_t mtDiag1PageValue =
      m_admtController->getSensorPage(ADMTController::SensorRegister::DIAG1);
  uint32_t cnvPageAddress = m_admtController->getConfigurationRegister(
      ADMTController::ConfigurationRegister::CNVPAGE);
  ...
  if (m_admtController->writeDeviceRegistry(
    ...
    if (m_admtController->readDeviceRegistry(
      ...
      if (*cnvPageRegValue == mtDiag1PageValue) {
        if (m_admtController->readDeviceRegistry(
          ...
          *mtDiag1RegValue16 = static_cast<uint16_t>(*mtDiag1RegValue);
          ...
          Q_EMIT commandLogWriteSignal(
              "Failed to read MT Diagnostic 1 Register");
        }
      } else {
        Q_EMIT commandLogWriteSignal(
      ...
      Q_EMIT commandLogWriteSignal(
          "Failed to read CNVPAGE for MT Diagnostic 1");
    }
  } else {
...
void HarmonicCalibration::updateMTDiagnosticRegisterUI(
    uint16_t *registerValue) {
  DIAG1RegisterMap =
      m_admtController->getDiag1RegisterBitMapping_Register(*registerValue);
  DIAG1AFERegisterMap =
      m_admtController->getDiag1RegisterBitMapping_Afe(*registerValue, is5V);
...
void HarmonicCalibration::getFAULTRegister() {
  ...
  uint32_t faultRegisterAddress = m_admtController->getConfigurationRegister(
      ADMTController::ConfigurationRegister::FAULT);
  m_admtController->writeDeviceRegistry(
      m_admtController->getDeviceId(ADMTController::Device::ADMT4000),
  ...
  if (m_admtController->readDeviceRegistry(
    ...
    *faultRegValue16 = static_cast<uint16_t>(*faultRegValue);
    ...
    Q_EMIT commandLogWriteSignal(
        "FAULT: 0b" +
        QString::number(*faultRegValue, 2).rightJustified(16, '0'));
...
void HarmonicCalibration::updateFaultRegisterUI(uint16_t *faultRegValue) {
  FAULTRegisterMap =
      m_admtController->getFaultRegisterBitMapping(*faultRegValue);
  ...
  CountSensorFalseStateStatusLED->setChecked(
      regmap.at("Count Sensor False State"));
  AngleCrossCheckStatusLED->setChecked(regmap.at("Angle Cross Check"));
  TurnCountSensorLevelsStatusLED->setChecked(
      regmap.at("Turn Count Sensor Levels"));
  MTDIAGStatusLED->setChecked(regmap.at("MT Diagnostic"));
  TurnCounterCrossCheckStatusLED->setChecked(
      regmap.at("Turn Counter Cross Check"));
...
void HarmonicCalibration::updateLabelValue(
    QLabel *label, ADMTController::MotorAttribute attribute) {
  switch (attribute) {
...
void HarmonicCalibration::updateLineEditValue(QLineEdit *lineEdit,
                                              double value) {
...
void HarmonicCalibration::changeCustomSwitchLabel(CustomSwitch *customSwitch,
                                                  QString onLabel,
                                                  QString offLabel) {
...
QCheckBox *HarmonicCalibration::createStatusLEDWidget(const QString &text,
                                                      QVariant variant,
                                                      bool checked,
                                                      QWidget *parent) {
  QCheckBox *checkBox = new QCheckBox(text, parent);
  Style::setStyle(checkBox, style::properties::admt::checkBoxLED, variant,
                  true);
...
MenuControlButton *
HarmonicCalibration::createChannelToggleWidget(const QString title,
  ...
  menuControlButton->setCheckBoxStyle(
      MenuControlButton::CheckboxStyle::CS_CIRCLE);
...
void HarmonicCalibration::connectLineEditToNumber(QLineEdit *lineEdit,
                                                  int &variable, int min,
                                                  int max) {
  QIntValidator *validator = new QIntValidator(min, max, this);
  lineEdit->setValidator(validator);
  connect(lineEdit, &QLineEdit::editingFinished, this,
          [&variable, lineEdit, min, max]() {
            bool ok;
...
void HarmonicCalibration::connectLineEditToNumber(QLineEdit *lineEdit,
                                                  ...
                                                  QString unit) {
  connect(lineEdit, &QLineEdit::editingFinished, this,
          [&variable, lineEdit, unit]() {
            bool ok;
            double value =
                lineEdit->text().replace(unit, "").trimmed().toDouble(&ok);
            if (ok) {
              variable = value;
...
void HarmonicCalibration::connectLineEditToDouble(QLineEdit *lineEdit,
                                                  double &variable) {
...
void HarmonicCalibration::connectLineEditToNumberWrite(
    QLineEdit *lineEdit, double &variable,
...
void HarmonicCalibration::connectMenuComboToNumber(MenuCombo *menuCombo,
                                                   double &variable) {
...
void HarmonicCalibration::connectLineEditToRPSConversion(QLineEdit *lineEdit,
                                                         double &vmax) {
...
void HarmonicCalibration::connectLineEditToAMAXConversion(QLineEdit *lineEdit,
                                                          double &amax) {
...
void HarmonicCalibration::connectRegisterBlockToRegistry(
    RegisterBlockWidget *widget) {
  uint32_t *readValue = new uint32_t;
  ...
  if (widget->getAccessPermission() ==
          RegisterBlockWidget::ACCESS_PERMISSION::READWRITE ||
      widget->getAccessPermission() ==
          RegisterBlockWidget::ACCESS_PERMISSION::WRITE) {
    connect(widget->writeButton(), &QPushButton::clicked, this, [this, widget, readValue] {
      ...
      if (ok) {
        if (m_admtController->writeDeviceRegistry(
          ...
          if (m_admtController->readDeviceRegistry(
                  m_admtController->getDeviceId(
                      ADMTController::Device::ADMT4000),
                  widget->getAddress(), readValue) == 0) {
            widget->setValue(*readValue);
            success = true;
          }
...
void HarmonicCalibration::connectLineEditToRPM(QLineEdit *lineEdit,
                                               double &variable) {
  QDoubleValidator *validator = new QDoubleValidator(this);
  validator->setNotation(QDoubleValidator::StandardNotation);
  lineEdit->setValidator(validator);
...
double HarmonicCalibration::convertAccelTimetoAMAX(double accelTime) {
  return (rotate_vmax * static_cast<double>(1 << 17) / accelTime /
          motorfCLK); // 1 << 17 = 2^17 = 131072
}

double HarmonicCalibration::convertAMAXtoAccelTime(double amax) {
  return ((rotate_vmax * static_cast<double>(1 << 17)) /
          (amax * motorfCLK)); // 1 << 17 = 2^17 = 131072
}
...
QString HarmonicCalibration::readRegmapDumpAttributeValue() {
  ...
  result = m_admtController->getDeviceAttributeValueString(
      m_admtController->getDeviceId(ADMTController::Device::ADMT4000),
      m_admtController->getDeviceAttribute(
          ADMTController::DeviceAttribute::REGMAP_DUMP),
      value, 1024);

...
HorizontalSpinBox::HorizontalSpinBox(QString header, double initialValue,
                                     QString unit, QWidget *parent)
    : QWidget(parent), m_value(initialValue), m_unit(unit) {
...
void HorizontalSpinBox::applyPushButtonStyle(QPushButton *widget,
                                             int topLeftBorderRadius,
                                             int topRightBorderRadius,
                                             int bottomLeftBorderRadius,
                                             int bottomRightBorderRadius) {
  QString style = QString(R"css(
                                QPushButton{
                                    background-color: black;
                                    font-family: Open Sans;
  ...
  style = style.replace(QString("&&topLeftBorderRadius&&"),
                        QString::number(topLeftBorderRadius));
  style = style.replace(QString("&&topRightBorderRadius&&"),
                        QString::number(topRightBorderRadius));
  style = style.replace(QString("&&bottomLeftBorderRadius&&"),
                        QString::number(bottomLeftBorderRadius));
  style = style.replace(QString("&&bottomRightBorderRadius&&"),
                        QString::number(bottomRightBorderRadius));
  widget->setStyleSheet(style);
  widget->setFixedHeight(30);

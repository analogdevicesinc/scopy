...
void HorizontalSpinBox::setValue(double value) { m_lineEdit->setText(QString::number(value)); }
...
void HorizontalSpinBox::applyPushButtonStyle(QPushButton *widget, int topLeftBorderRadius, int topRightBorderRadius,
					     int bottomLeftBorderRadius, int bottomRightBorderRadius)
{
	QString style = QString(R"css(
                                QPushButton{
                                    background-color: black;

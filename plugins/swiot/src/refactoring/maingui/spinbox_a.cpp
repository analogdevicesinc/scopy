...
#include "src/refactoring/maincore/apiobjectmanager.h"
#include "src/refactoring/maincore/singletone_wrapper.h"
...
//	m_sba_api->save(*m_settings); // TODO: idk restore this, temporary fix for migrating to scopy 2.0

...
SwiotConfigModel::SwiotConfigModel(struct iio_channel* adChannel, struct iio_channel* maxChannel)
{
...
SwiotConfigModel::~SwiotConfigModel()
{}

void SwiotConfigModel::initChnlAttrValues(struct iio_channel* iioChnl)
{
	if (iioChnl) {
...
QStringList SwiotConfigModel::readChnlAttr(struct iio_channel* iio_chnl, QString attrName)
{
	QStringList attrValues;
...
void SwiotConfigModel::updateChnlAttributes(QVector<QMap<QString,QStringList>> newValues, QString attrName,
					    int deviceIdx)
{
...
QVector<QMap<QString, QStringList>> SwiotConfigModel::getChnlsAttrValues()
{
	return m_attrValues;
}

QStringList SwiotConfigModel::getActiveFunctions()
{
	QStringList func;

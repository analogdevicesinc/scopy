...
<itembitsize>:
 - The size of an item (in bits). For a 4-bit unary code bus this is 4,
   for a 16-bit unary code bus this is 16, and so on.
...
class Decoder(srd.Decoder):
    ...
    id = 'unary'
    name = 'Unary'
    longname = 'Unary code bus'
    desc = 'Generic unary code bus.'
    license = 'gplv2+'
    inputs = ['logic']
    outputs = ['unary']

...
bool DMM_API::get_mode_ac_high_ch1() const { return dmm->ui->btn_ch1_ac2->isChecked(); }

bool DMM_API::get_mode_ac_low_ch1() const { return dmm->ui->btn_ch1_ac->isChecked(); }

bool DMM_API::get_mode_ac_high_ch2() const { return dmm->ui->btn_ch2_ac2->isChecked(); }

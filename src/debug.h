...
public:
	...
	void writeAttribute(QString devName, QString channel, QString attribute,
	                    QString value);
	QStringList getAvailableValues(QString devName, QString channel,
	                               QString attribute);
	QString getAttributeValue(QString devName, QString channel, QString attribute);
	void setAttributeValue(QString devName, QString channel, QString attribute,
	                       QString value);

...
double GenericDac::convVoltsToSample(double volts) { return 0; }

double GenericDac::vOutL() const { return m_vOutL; }

void GenericDac::setVOutL(double value) { m_vOutL = value; }

double GenericDac::vOutH() const { return m_vOutH; }

void GenericDac::setVOutH(double value) { m_vOutH = value; }

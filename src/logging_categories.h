...
Q_DECLARE_LOGGING_CATEGORY(CAT_CURSOR_RIGHTMENU_PLUGIN)
Q_DECLARE_LOGGING_CATEGORY(CAT_IRIGHTMENU_PLUGIN)
Q_DECLARE_LOGGING_CATEGORY(CAT_ICHANNEL_PLUGIN)
Q_DECLARE_LOGGING_CATEGORY(CAT_ADDCHANNEL_PLUGIN)
Q_DECLARE_LOGGING_CATEGORY(CAT_PHYSICALCHANNEL_PLUGIN)
Q_DECLARE_LOGGING_CATEGORY(CAT_REFCHANNEL_PLUGIN)
Q_DECLARE_LOGGING_CATEGORY(CAT_MARKER_RIGHTMENU_PLUGIN)
Q_DECLARE_LOGGING_CATEGORY(CAT_TOOLVIEW)
Q_DECLARE_LOGGING_CATEGORY(CAT_BASEPLUGIN)
Q_DECLARE_LOGGING_CATEGORY(CAT_FFTPLOT_PLUGIN)
#else
...
#define CAT_PLOT
#define CAT_CURSOR_RIGHTMENU_PLUGIN
#define CAT_IRIGHTMENU_PLUGIN
#define CAT_ICHANNEL_PLUGIN
#define CAT_ADDCHANNEL_PLUGIN
#define CAT_PHYSICALCHANNEL_PLUGIN
#define CAT_REFCHANNEL_PLUGIN
#define CAT_MARKER_RIGHTMENU_PLUGIN
#define CAT_TOOLVIEW
#define CAT_BASEPLUGIN
#define CAT_FFTPLOT_PLUGIN
#endif

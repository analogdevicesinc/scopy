...
DragZone::DragZone(QWidget *parent) : QWidget(parent), ui(new Ui::DragZone) {
	ui->setupUi(this);
	position = 8;
	setAcceptDrops(true);
...
int DragZone::getPosition() const { return position; }

void DragZone::setPosition(int value) { position = value; }

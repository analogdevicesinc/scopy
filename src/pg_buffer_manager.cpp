...
PatternGeneratorBufferManagerUi::PatternGeneratorBufferManagerUi(QWidget *parent, PatternGeneratorBufferManager *bufmanager, QWidget *settingsWidget, PatternGenerator* pg) : QWidget(parent), settingsWidget(settingsWidget), bufman(bufmanager)
{

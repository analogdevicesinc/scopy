...
void PatternGeneratorChannelManager::commitBuffer(PatternGeneratorChannelGroup *chg, short *buffer,
						  uint32_t bufferSize) {
...
void PatternGeneratorChannelManagerUI::highlightChannel(PatternGeneratorChannelGroup *chg,

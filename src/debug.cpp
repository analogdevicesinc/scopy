...
QStringList Debug::getAvailableValues(QString devName, QString channel, QString attribute)
{
    struct iio_device *device;
    struct iio_channel *ch;
    char value[100];
...
QString Debug::readAttribute(QString devName, QString channel, QString attribute)
{
    struct iio_device *device;
    struct iio_channel *ch;
    char value[100];
...
void Debug::writeAttribute(QString devName, QString channel, QString attribute, QString value)
{
    struct iio_device *device;
    struct iio_channel *ch;
    bool isOutput;

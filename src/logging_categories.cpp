...
Q_LOGGING_CATEGORY(CAT_MARKER_RIGHTMENU_PLUGIN, "MarkerRightMenuPlugin")
Q_LOGGING_CATEGORY(CAT_TOOLVIEW, "ToolView")
Q_LOGGING_CATEGORY(CAT_BASEPLUGIN, "BasePlugin")
Q_LOGGING_CATEGORY(CAT_FFTPLOT_PLUGIN, "FftPlotPlugin")

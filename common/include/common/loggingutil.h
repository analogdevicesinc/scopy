...
public:
	...
	static inline void logMessage(const QLoggingCategory &category(), const QString &message, LogLevel level,
				      bool pushToStatusBar = false, int ms = DEFAULT_DISPLAY_TIME)
	{
		if(pushToStatusBar) {

...
void EditableGuiStrategy::setCustomTitle(QString title) { m_toolTipTitle->setTitle(title); }

void EditableGuiStrategy::setToolTip(QString toolTip) { m_toolTipTitle->setToolTip(toolTip); }

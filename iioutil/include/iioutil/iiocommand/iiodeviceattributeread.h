...
class SCOPY_IIOUTIL_EXPORT IioDeviceAttributeRead : public Command {
	Q_OBJECT
public:
	explicit IioDeviceAttributeRead(struct iio_device *device,
	...
	virtual void execute() override {
		...
		ssize_t ret = iio_device_attr_read(m_device, m_attribute_name.c_str(), (char*)m_cmdResult->results, m_maxAttrSize);
